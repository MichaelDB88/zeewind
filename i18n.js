  ...
  var COPY = {
    en: {
      ...
      home: {
        ...
        houseCopy1: 'Holiday Home NordHuys is a charming holiday home nestled within a peaceful vacation domain, just steps from the Belgian coastline. With its warm atmosphere and thoughtful amenities, it is the perfect retreat for families, couples, and friends — four-legged companions welcome too.',
    ...
    nl: {
      ...
      home: {
        ...
        houseCopy1: 'Vakantiehuis NordHuys is een charmant vakantiehuis in een rustig vakantiedomein, vlak bij de Belgische kust. Met zijn warme sfeer en praktische voorzieningen is het een ideale plek voor gezinnen, koppels en vrienden — viervoeters zijn ook welkom.',
    ...
    fr: {
      ...
      home: {
        ...
        houseCopy1: 'Maison de vacances NordHuys est une charmante maison de vacances située dans un domaine paisible, à deux pas de la côte belge. Avec son atmosphère chaleureuse et ses équipements pratiques, c\'est un refuge idéal pour familles, couples et amis — compagnons à quatre pattes bienvenus.',
    ...
    de: {
      ...
      home: {
        ...
        houseCopy1: 'Ferienhaus NordHuys ist ein charmantes Ferienhaus in einer ruhigen Ferienanlage, nur wenige Schritte von der belgischen Küste entfernt. Mit warmer Atmosphäre und praktischer Ausstattung ist es ideal für Familien, Paare und Freunde — vierbeinige Begleiter sind ebenfalls willkommen.',
