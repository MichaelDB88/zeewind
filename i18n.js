  ...
  var COPY = {
    en: {
      ...
      booking: {
        ...
        infoBox: '<strong>How it works:</strong> Choose your dates, add any extras, and send us your request. We check availability first and then reply with the next steps, usually within 24 hours. No payment is taken here. Special requests or alternative dates in mind? Send us a request and we will gladly see what we can do.',
    ...
    nl: {
      ...
      booking: {
        ...
        infoBox: '<strong>Zo werkt het:</strong> Kies je data, voeg eventuele extra\'s toe en stuur ons je aanvraag. We controleren eerst de beschikbaarheid en bezorgen je daarna de volgende stappen, meestal binnen 24 uur. Hier wordt nog geen betaling gevraagd. Speciale wensen of andere data in gedachten? Stuur ons je aanvraag en we bekijken graag wat mogelijk is.',
    ...
    de: {
      ...
      booking: {
        ...
        infoBox: '<strong>So funktioniert es:</strong> Wählen Sie Ihre Daten, fügen Sie gewünschte Extras hinzu und senden Sie uns Ihre Anfrage. Wir prüfen zuerst die Verfügbarkeit und melden uns dann mit den nächsten Schritten, normalerweise innerhalb von 24 Stunden. Hier wird noch keine Zahlung vorgenommen. Besondere Wünsche oder andere Daten im Sinn? Senden Sie uns Ihre Anfrage und wir prüfen gerne, was möglich ist.',
