(function () {
  ...
  var COPY = {
    ...
    nl: {
      meta: {
        homeTitle: 'Holiday Home Zeebries - Vakantiehuis aan de Belgische kust',
        homeDescription: 'Holiday Home Zeebries - een mooi vakantiehuis aan de Belgische kust. Hondvriendelijk, private tuin, parking en toegang tot zwembad. Boek vandaag je verblijf.',
        bookingTitle: 'Boek je verblijf - Holiday Home Zeebries',
        bookingDescription: 'Bekijk de beschikbaarheid en stuur een boekingsaanvraag voor vakantiehuis Holiday Home Zeebries in Bredene.',
        thingsTitle: 'Wat te doen in de buurt van Holiday Home Zeebries in Bredene | Belgische kust',
        thingsDescription: 'Ontdek wat er te doen is bij Holiday Home Zeebries in het vakantiepark in Bredene, inclusief het nieuwe LAGO Bredene Grasduinen zwembad, stranden, duinen en gezinsvriendelijke activiteiten aan de Belgische kust.',
        reviewsTitle: 'Gastbeoordelingen | Holiday Home Zeebries',
        reviewsDescription: 'Lees ervaringen en beoordelingen van gasten die verbleven in vakantiehuis Holiday Home Zeebries in Bredene.'
      },
      common: {
        navHouse: 'Ons huis',
        ...
        languageLabel: 'Taal',
        menuLabel: 'Menu',
        footer: '(c) 2026 Holiday Home Zeebries · Vakantiehuis aan de Belgische kust · Alle rechten voorbehouden',
      ...
      home: {
        ...
        houseCopy1: 'Holiday Home Zeebries is een charmant vakantiehuis in een rustig vakantiedomein, vlak bij de Belgische kust. Met zijn warme sfeer en praktische voorzieningen is het een ideale plek voor gezinnen, koppels en vrienden — viervoeters zijn ook welkom.',
        ...
        beachAlt: 'Het strand bij Holiday Home Zeebries, op slechts enkele minuten',
        amenitiesLabel: 'Voorzieningen',
        amenitiesTitle: 'Alles wat je nodig hebt',
        amenitiesSub: 'Holiday Home Zeebries is uitgerust en klaar zodat je echt kunt ontspannen en genieten.',
        ...
        parkPoolAlt: 'Verwarmd buitenzwembad bij Holiday Home Zeebries',
        ...
        gallerySub: 'Een paar beelden van wat je bij Holiday Home Zeebries mag verwachten.',
        galleryBeachAlt: 'Het strand bij Holiday Home Zeebries',
        galleryDunesAlt: 'Duinen bij Holiday Home Zeebries',
        ...
        locationCopy: 'Holiday Home Zeebries ligt in het vakantiepark in Bredene, dicht bij de Belgische kust. Het exacte adres krijg je bij de boekingsbevestiging.',
      ...
      things: {
        ...
        heroTitle: 'Wat te doen in de buurt van Holiday Home Zeebries',
        ...
        guideCopy: 'Of je nu met kinderen reist, een ontspannen kustvakantie plant of leuke activiteiten zoekt dicht bij je vakantiehuis in Bredene: vanuit Holiday Home Zeebries zit je vlak bij veel praktische en aangename opties in de omgeving.',
        guideCopy2: 'Van zwemmen en gezinsplezier tot een culturele uitstap naar Oostende, een maaltijd in het vakantiepark of een rustige ochtend in de duinen — deze gids bundelt de makkelijkste dingen om te doen bij Holiday Home Zeebries zonder ingewikkelde planning.',
        activitiesLabel: 'Activiteiten & ideeën',
        activitiesTitle: 'Wat te doen nabij Holiday Home Zeebries',
        ...
        lagoTitle: 'LAGO Bredene Grasduinen',
        lagoCopy1: 'Een van de makkelijkste gezinsactiviteiten vlak bij Holiday Home Zeebries. Een modern zwem- en recreatiecentrum met waterspel voor kinderen, binnenspeeltuin, buitenbaden, sauna en bistro. Een praktische keuze op een regenachtige dag of wanneer kinderen eens iets anders willen dan het strand.',
        ...
        beachImgAlt: 'Het strand en de duinen nabij Holiday Home Zeebries in Bredene',
        beachTag: 'Strand & natuur',
        beachTitle: 'Strand en duinen',
        beachCopy: 'Bredene staat bekend om zijn natuurlijke strand en duinen — perfect voor rustige ochtenden, lange wandelingen, zandkastelen en frisse zeelucht. Vanuit Holiday Home Zeebries wordt strandtijd makkelijk deel van je dagelijkse ritme, zonder auto of groot plan.',
        beachFact1: '<strong>Ideaal voor:</strong> Alle leeftijden, wandelingen, ontspannen, gezinnen',
        beachFact2: '<strong>Afstand:</strong> Korte wandeling vanaf Holiday Home Zeebries',
        cyclingImgAlt: 'Fietsroutes nabij Bredene en de Belgische kust',
        cyclingTag: 'Fietsen & wandelen',
        cyclingTitle: 'Fietsen en wandelen',
        cyclingCopy: 'De Belgische kust verken je makkelijk met de fiets of te voet. Vanuit Holiday Home Zeebries kunnen gasten op hun eigen tempo routes door Bredene, de duinen en nabijgelegen kustplaatsen volgen — een korte gezinswandeling, een langere fietstocht of een mooie route richting zee.',
        ...
        ostendFact2: '<strong>Afstand:</strong> Korte rit met de auto of fiets vanaf Holiday Home Zeebries',
        ...
        dehaanCopy: 'De Haan staat bekend om zijn charmante kustsfeer en Belle Époque-villa’s. Een goede keuze wanneer je eens een andere omgeving wilt zonder de dag ingewikkeld te maken. Geniet van een wandeling, een drankje, een maaltijd of gewoon een andere kustsfeer voor je terugkeert naar Holiday Home Zeebries.',
        ...
        tourismCopy2: 'Deze link is vooral handig voor actuele dingen om te doen in Bredene die doorheen het jaar veranderen, terwijl deze pagina de meest praktische opties bundelt voor gasten die in Holiday Home Zeebries verblijven.',
        tourismLink: 'Bezoek de officiële toeristische website van Bredene',
        ctaLabel: 'Verblijf in Holiday Home Zeebries',
        ctaTitle: 'Maak van Bredene je vakantiebasis',
        ctaCopy: 'Verblijf in Holiday Home Zeebries en geniet van een vakantiehuis in het hart van Bredene, dicht bij strand, zwemmen, eten en drinken, gezinsactiviteiten en eenvoudige uitstappen langs de Belgische kust.'
      },
      bookingDynamic: {
    ...
    fr: {
      meta: {
        homeTitle: 'Holiday Home Zeebries - Maison de vacances à la côte belge',
        homeDescription: 'Holiday Home Zeebries - une belle maison de vacances à la côte belge. Chien admis, jardin privé, parking et accès à la piscine. Réservez votre séjour.',
        bookingTitle: 'Réserver votre séjour - Holiday Home Zeebries',
        bookingDescription: 'Consultez les disponibilités et envoyez une demande de réservation pour la maison de vacances Holiday Home Zeebries à Bredene.',
        thingsTitle: 'Que faire près de Holiday Home Zeebries à Bredene | Côte belge',
        thingsDescription: 'Découvrez les activités près de Holiday Home Zeebries dans le parc de vacances à Bredene, dont la nouvelle piscine LAGO Bredene Grasduinen, les plages, les dunes et les sorties familiales à la côte belge.',
        reviewsTitle: 'Avis des voyageurs | Holiday Home Zeebries',
        reviewsDescription: 'Lisez les avis et expériences des voyageurs ayant séjourné à Holiday Home Zeebries, maison de vacances à Bredene.'
      },
      common: {
        ...
        menuLabel: 'Menu',
        footer: '(c) 2026 Holiday Home Zeebries · Maison de vacances à la côte belge · Tous droits réservés',
      ...
      home: {
        ...
        houseCopy1: 'Holiday Home Zeebries est une charmante maison de vacances située dans un domaine paisible, à deux pas de la côte belge. Avec son atmosphère chaleureuse et ses équipements pratiques, c’est un refuge idéal pour familles, couples et amis — compagnons à quatre pattes bienvenus.',
        ...
        maxGuests: 'Pers. max.',
        beachAlt: 'La plage près de Holiday Home Zeebries, à quelques minutes',
        amenitiesLabel: 'Équipements',
        amenitiesTitle: 'Tout ce qu’il faut',
        amenitiesSub: 'Holiday Home Zeebries est équipée et prête pour vous permettre de vraiment déconnecter.',
        ...
        parkPoolAlt: 'Piscine extérieure chauffée à Holiday Home Zeebries',
        ...
        gallerySub: 'Quelques images de l’atmosphère qui vous attend à Holiday Home Zeebries.',
        galleryBeachAlt: 'La plage près de Holiday Home Zeebries',
        galleryDunesAlt: 'Les dunes près de Holiday Home Zeebries',
        comingSoon: '📷 Bientôt',
        ...
        locationCopy: 'Holiday Home Zeebries se trouve dans le parc de vacances à Bredene, près de la côte belge. L’adresse exacte est communiquée lors de la confirmation de réservation.',
      ...
      things: {
        ...
        heroTitle: 'Que faire près de Holiday Home Zeebries',
        ...
        guideCopy: 'Que vous voyagiez avec des enfants, prépariez une pause tranquille à la côte ou cherchiez des activités faciles près de votre maison de vacances à Bredene, Holiday Home Zeebries vous place près de nombreuses options pratiques et agréables.',
        guideCopy2: 'De la natation et des activités familiales à une excursion culturelle à Ostende, un repas dans le parc de vacances ou une matinée calme dans les dunes — ce guide rassemble les choses les plus simples à faire près de Holiday Home Zeebries sans itinéraire compliqué.',
        activitiesLabel: 'Activités & idées',
        activitiesTitle: 'Que faire près de Holiday Home Zeebries',
        ...
        beachImgAlt: 'La plage et les dunes près de Holiday Home Zeebries à Bredene',
        beachTag: 'Plage & nature',
        beachTitle: 'Plage et dunes',
        beachCopy: 'Bredene est connue pour sa plage naturelle et ses dunes — parfaites pour les matinées lentes, les longues promenades, les châteaux de sable et l’air marin. Depuis Holiday Home Zeebries, la plage s’intègre facilement au rythme quotidien, sans voiture ni grand plan.',
        beachFact1: '<strong>Idéal pour :</strong> Tous les âges, promenades, détente, familles',
        beachFact2: '<strong>Distance :</strong> Courte promenade depuis Holiday Home Zeebries',
        ...
        ostendFact2: '<strong>Distance :</strong> Court trajet en voiture ou à vélo depuis Holiday Home Zeebries',
        ...
        tourismCopy2: 'Ce lien est particulièrement utile pour les choses à faire à Bredene qui changent au fil de l’année, tandis que cette page reprend les options les plus pratiques pour les hôtes séjournant à Holiday Home Zeebries.',
        tourismLink: 'Visiter le site touristique officiel de Bredene',
        ctaLabel: 'Séjourner à Holiday Home Zeebries',
        ctaTitle: 'Faites de Bredene votre base de vacances',
        ctaCopy: 'Séjournez à Holiday Home Zeebries et profitez d’une maison de vacances au cœur de Bredene, près de la plage, de la piscine, des restaurants, des activités familiales et des excursions faciles le long de la côte belge.'
      },
      bookingDynamic: {
    ...
    de: {
      meta: {
        homeTitle: 'Holiday Home Zeebries - Ferienhaus an der belgischen Küste',
        homeDescription: 'Holiday Home Zeebries - ein schönes Ferienhaus an der belgischen Küste. Hundefreundlich, privater Garten, Parkplatz und Zugang zum Pool. Buchen Sie Ihren Aufenthalt.',
        bookingTitle: 'Aufenthalt buchen - Holiday Home Zeebries',
        bookingDescription: 'Prüfen Sie die Verfügbarkeit und senden Sie eine Buchungsanfrage für das Ferienhaus Holiday Home Zeebries in Bredene.',
        thingsTitle: 'Aktivitäten in der Nähe von Holiday Home Zeebries in Bredene | Belgische Küste',
        thingsDescription: 'Entdecken Sie Aktivitäten bei Holiday Home Zeebries im Ferienpark in Bredene, darunter das neue Schwimmbad LAGO Bredene Grasduinen, Strände, Dünen und familienfreundliche Ausflüge an der belgischen Küste.',
        reviewsTitle: 'Gästebewertungen | Holiday Home Zeebries',
        reviewsDescription: 'Lesen Sie Bewertungen und Erfahrungen von Gästen des Ferienhauses Holiday Home Zeebries in Bredene.'
      },
      common: {
        ...
        menuLabel: 'Menü',
        footer: '(c) 2026 Holiday Home Zeebries · Ferienhaus an der belgischen Küste · Alle Rechte vorbehalten',
      ...
      home: {
        ...
        houseCopy1: 'Holiday Home Zeebries ist ein charmantes Ferienhaus in einer ruhigen Ferienanlage, nur wenige Schritte von der belgischen Küste entfernt. Mit warmer Atmosphäre und praktischer Ausstattung ist es ideal für Familien, Paare und Freunde — vierbeinige Begleiter sind ebenfalls willkommen.',
        ...
        bathroom: 'Bad',
        maxGuests: 'Max. Gäste',
        beachAlt: 'Der Strand bei Holiday Home Zeebries, nur wenige Minuten entfernt',
        amenitiesLabel: 'Ausstattung',
        amenitiesTitle: 'Alles, was Sie brauchen',
        amenitiesSub: 'Holiday Home Zeebries ist ausgestattet und bereit, damit Sie wirklich abschalten können.',
        ...
        parkPoolAlt: 'Beheizter Außenpool bei Holiday Home Zeebries',
        ...
        gallerySub: 'Ein paar Eindrücke von dem, was Sie bei Holiday Home Zeebries erwartet.',
        galleryBeachAlt: 'Der Strand bei Holiday Home Zeebries',
        galleryDunesAlt: 'Dünen bei Holiday Home Zeebries',
        comingSoon: '📷 Demnächst',
        galleryNote: 'Fotos vom Haus folgen bald. Der Strand ist nur wenige Minuten entfernt.',
        locationLabel: 'Lage',
        locationTitle: 'Wo Sie uns finden',
        locationCopy: 'Holiday Home Zeebries liegt im Ferienpark in Bredene, nahe der belgischen Küste. Die genaue Adresse erhalten Sie mit der Buchungsbestätigung.',
      ...
      things: {
        ...
        heroTitle: 'Aktivitäten in der Nähe von Holiday Home Zeebries',
        ...
        guideCopy: 'Ob Sie mit Kindern reisen, eine entspannte Küstenpause planen oder einfache Aktivitäten nahe Ihrem Ferienhaus in Bredene suchen: Von Holiday Home Zeebries aus sind viele praktische und schöne Möglichkeiten in der Umgebung schnell erreichbar.',
        guideCopy2: 'Vom Schwimmen und Familienspaß über einen kulturellen Ausflug nach Ostende bis zu einem Essen im Ferienpark oder einem ruhigen Morgen in den Dünen — dieser Guide bündelt die einfachsten Aktivitäten nahe Holiday Home Zeebries ohne komplizierte Planung.',
        activitiesLabel: 'Aktivitäten & Ideen',
        activitiesTitle: 'Was tun nahe Holiday Home Zeebries',
        ...
        lagoTitle: 'LAGO Bredene Grasduinen',
        lagoCopy1: 'Eine der einfachsten Familienaktivitäten nahe Holiday Home Zeebries. Ein modernes Schwimm- und Freizeitzentrum mit Wasserspielbereich für Kinder, Indoor-Spielbereich, Außenbecken, Sauna und Bistro. Eine praktische Wahl an Regentagen oder wenn Kinder Abwechslung vom Strand möchten.',
        ...
        beachImgAlt: 'Strand und Dünen nahe Holiday Home Zeebries in Bredene',
        beachTag: 'Strand & Natur',
        beachTitle: 'Strand und Dünen',
        beachCopy: 'Bredene ist für seinen natürlichen Strand und seine Dünen bekannt — perfekt für ruhige Morgen, lange Spaziergänge, Sandburgen und frische Meeresluft. Von Holiday Home Zeebries aus wird Strandzeit leicht Teil des täglichen Rhythmus, ohne Auto oder großen Plan.',
        beachFact1: '<strong>Ideal für:</strong> Alle Altersgruppen, Spaziergänge, Entspannung, Familien',
        beachFact2: '<strong>Entfernung:</strong> Kurzer Spaziergang ab Holiday Home Zeebries',
        ...
        cyclingCopy: 'Die belgische Küste lässt sich leicht mit dem Rad oder zu Fuß erkunden. Von Holiday Home Zeebries aus können Gäste in ihrem eigenen Tempo Routen durch Bredene, die Dünen und nahe Küstenorte genießen — einen kurzen Familienspaziergang, eine längere Radtour oder eine schöne Strecke Richtung Meer.',
        ...
        ostendFact2: '<strong>Entfernung:</strong> Kurze Auto- oder Radfahrt ab Holiday Home Zeebries',
        ...
        dehaanCopy: 'De Haan ist für seine charmante Küstenatmosphäre und Belle-Époque-Villen bekannt. Eine gute Option, wenn Sie eine andere Umgebung möchten und den Tag trotzdem einfach halten wollen. Genießen Sie einen Spaziergang, ein Getränk, eine Mahlzeit oder einfach ein anderes Küstengefühl, bevor Sie nach Holiday Home Zeebries zurückkehren.',
        ...
        tourismCopy2: 'Dieser Link ist besonders hilfreich für aktuelle Aktivitäten in Bredene, die sich im Laufe des Jahres ändern, während diese Seite die praktischsten Optionen für Gäste in Holiday Home Zeebries zusammenfasst.',
        tourismLink: 'Offizielle Tourismus-Website von Bredene besuchen',
        ctaLabel: 'Aufenthalt in Holiday Home Zeebries',
        ctaTitle: 'Machen Sie Bredene zu Ihrer Urlaubsbasis',
        ctaCopy: 'Übernachten Sie in Holiday Home Zeebries und genießen Sie ein Ferienhaus im Herzen von Bredene, nahe Strand, Schwimmen, Essen und Trinken, Familienaktivitäten und einfachen Ausflügen entlang der belgischen Küste.'
      },
      bookingDynamic: {
