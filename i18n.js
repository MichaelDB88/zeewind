(function () {
  ...
  var COPY = {
    en: {
      meta: {
        homeTitle: 'De Zilte Zee - Vacation Home at the Belgian Coast',
        homeDescription: 'De Zilte Zee - a beautiful holiday home at the Belgian coast. Pet-friendly, private garden, parking, and access to pool. Book your stay today.',
        bookingTitle: 'Book Your Stay - De Zilte Zee',
        bookingDescription: 'Check availability and send a booking request for De Zilte Zee holiday home in Bredene.',
        thingsTitle: 'Things to Do Near De Zilte Zee in Bredene | Belgian Coast',
        thingsDescription: 'Discover things to do near De Zilte Zee in the holiday park in Bredene, including the new LAGO Bredene Grasduinen swimming pool, beaches, dunes, and family-friendly activities on the Belgian coast.'
      },
      common: {
        navHouse: 'Our Home',
        ...
        menuLabel: 'Menu',
        footer: '2025 De Zilte Zee · Holiday Home at the Belgian Coast · All rights reserved',
      ...
      home: {
        ...
        houseCopy1: 'De Zilte Zee is a charming holiday home nestled within a peaceful vacation domain, just steps from the Belgian coastline. With its warm atmosphere and thoughtful amenities, it is the perfect retreat for families, couples, and friends — four-legged companions welcome too.',
        ...
        beachAlt: 'The beach near De Zilte Zee, just minutes away',
        amenitiesLabel: 'Amenities',
        amenitiesTitle: 'Everything you need',
        amenitiesSub: 'De Zilte Zee is equipped and ready so you can truly switch off and enjoy.',
        ...
        parkCopy: 'The holiday park has its own heated pool and restaurant — no need to go anywhere else.',
        parkPoolAlt: 'Heated outdoor pool at the holiday park',
        ...
        gallerySub: 'A few glimpses of what awaits you at De Zilte Zee.',
        galleryBeachAlt: 'The beach near De Zilte Zee',
        galleryDunesAlt: 'Dunes near De Zilte Zee',
        comingSoon: '📷 Coming soon',
        galleryNote: 'Photos of the house coming soon. The beach is just minutes away.',
        locationLabel: 'Location',
        locationTitle: 'Where to find us',
        locationCopy: 'De Zilte Zee is located at the holiday park in Bredene, close to the Belgian coast. Exact address provided upon booking confirmation.',
      ...
      things: {
        ...
        heroTitle: 'Things to Do Near De Zilte Zee',
        heroCopy: 'Our holiday home De Zilte Zee in the holiday park is in the heart of Bredene — a relaxed base for beach days, family activities, food and drinks, and easy day trips along the Belgian coast.',
        guideLabel: 'Local Guide',
        guideTitle: 'A holiday home in the heart of Bredene',
        guideCopy: 'Whether you are travelling with children, planning a relaxed coastal break, or looking for easy activities close to your holiday home in Bredene, De Zilte Zee puts you close to many of the area\'s most practical and enjoyable options.',
        guideCopy2: 'From swimming and family fun to a cultural day trip in Ostend, a meal inside the holiday park or a slow morning on the dunes — this guide covers the easiest things to do near De Zilte Zee without needing to plan a complicated itinerary.',
        activitiesLabel: 'Activities & Ideas',
        activitiesTitle: 'What to do near De Zilte Zee',
        gridSub: 'All recommendations are easy to combine with a stay at De Zilte Zee in the holiday park in Bredene. Add your own photos to each card whenever you have them.',
        ...
        lagoCopy1: 'One of the easiest family activities near De Zilte Zee. A modern swimming and recreation centre with children\'s water play, indoor play area, outdoor pools, sauna and bistro. A practical choice on a rainy day or when children want a change from the beach.',
        ...
        beachImgAlt: 'The beach and dunes near De Zilte Zee in Bredene',
        beachTag: 'Beach & Nature',
        beachTitle: 'Beach and dunes',
        beachCopy: 'Bredene is known for its natural beach and dunes — perfect for slow mornings, long walks, sandcastles and fresh sea air. From De Zilte Zee, beach time can easily become part of your daily rhythm without needing a car or a plan.',
        beachFact1: '<strong>Best for:</strong> All ages, walks, relaxing, families',
        beachFact2: '<strong>Distance:</strong> Short walk from De Zilte Zee',
        ...
        cyclingCopy: 'The Belgian coast is easy to explore by bike or on foot. From De Zilte Zee, guests can enjoy routes through Bredene, the dunes and nearby coastal towns at their own pace — a short family walk, a longer bike ride, or a scenic route towards the sea.',
        ...
        ostendFact2: '<strong>Distance:</strong> A short drive or bike ride from De Zilte Zee',
        ...
        dehaanCopy: 'De Haan is known for its charming coastal atmosphere and Belle Époque villas. A good option when you want a change of scenery while keeping the day simple. Enjoy a walk, a drink, a meal, or just the different coastal feeling before returning to De Zilte Zee.',
        ...
        tourismCopy2: 'This link is especially helpful for up-to-date things to do in Bredene that change throughout the year, while this page covers the most practical options for guests staying at De Zilte Zee.',
        tourismLink: 'Visit the official Bredene tourism website',
        ctaLabel: 'Stay at De Zilte Zee',
        ctaTitle: 'Make Bredene your holiday base',
        ctaCopy: 'Stay at De Zilte Zee and enjoy a holiday home in the heart of Bredene, close to the beach, swimming, food and drinks, family activities and easy day trips along the Belgian coast.'
      },
      bookingDynamic: {
    ...
    nl: {
      meta: {
        homeTitle: 'De Zilte Zee - Vakantiehuis aan de Belgische kust',
        homeDescription: 'De Zilte Zee - een mooi vakantiehuis aan de Belgische kust. Hondvriendelijk, private tuin, parking en toegang tot zwembad. Boek vandaag je verblijf.',
        bookingTitle: 'Boek je verblijf - De Zilte Zee',
        bookingDescription: 'Bekijk de beschikbaarheid en stuur een boekingsaanvraag voor vakantiehuis De Zilte Zee in Bredene.',
        thingsTitle: 'Wat te doen in de buurt van De Zilte Zee in Bredene | Belgische kust',
        thingsDescription: 'Ontdek wat er te doen is bij De Zilte Zee in het vakantiepark in Bredene, inclusief het nieuwe LAGO Bredene Grasduinen zwembad, stranden, duinen en gezinsvriendelijke activiteiten aan de Belgische kust.'
      },
      common: {
        navHouse: 'Ons huis',
        ...
        languageLabel: 'Taal',
        menuLabel: 'Menu',
        footer: '2025 De Zilte Zee · Vakantiehuis aan de Belgische kust · Alle rechten voorbehouden',
      ...
      home: {
        ...
        houseCopy1: 'De Zilte Zee is een charmant vakantiehuis in een rustig vakantiedomein, vlak bij de Belgische kust. Met zijn warme sfeer en praktische voorzieningen is het een ideale plek voor gezinnen, koppels en vrienden — viervoeters zijn ook welkom.',
        ...
        beachAlt: 'Het strand bij De Zilte Zee, op slechts enkele minuten',
        amenitiesLabel: 'Voorzieningen',
        amenitiesTitle: 'Alles wat je nodig hebt',
        amenitiesSub: 'De Zilte Zee is uitgerust en klaar zodat je echt kunt ontspannen en genieten.',
        ...
        parkCopy: 'Het vakantiepark heeft een eigen verwarmd zwembad en restaurant — je hoeft nergens anders heen.',
        parkPoolAlt: 'Verwarmd buitenzwembad bij De Zilte Zee',
        ...
        gallerySub: 'Een paar beelden van wat je bij De Zilte Zee mag verwachten.',
        galleryBeachAlt: 'Het strand bij De Zilte Zee',
        galleryDunesAlt: 'Duinen bij De Zilte Zee',
        ...
        locationCopy: 'De Zilte Zee ligt in het vakantiepark in Bredene, dicht bij de Belgische kust. Het exacte adres krijg je bij de boekingsbevestiging.',
      ...
      things: {
        ...
        heroTitle: 'Wat te doen in de buurt van De Zilte Zee',
        heroCopy: 'Ons vakantiehuis De Zilte Zee in het vakantiepark ligt in het hart van Bredene — een ontspannen uitvalsbasis voor stranddagen, gezinsactiviteiten, eten en drinken en eenvoudige uitstappen langs de Belgische kust.',
        guideLabel: 'Lokale gids',
        guideTitle: 'Een vakantiehuis in het hart van Bredene',
        guideCopy: 'Of je nu met kinderen reist, een ontspannen kustvakantie plant of leuke activiteiten zoekt dicht bij je vakantiehuis in Bredene: vanuit De Zilte Zee zit je vlak bij veel praktische en aangename opties in de omgeving.',
        guideCopy2: 'Van zwemmen en gezinsplezier tot een culturele uitstap naar Oostende, een maaltijd in het vakantiepark of een rustige ochtend in de duinen — deze gids bundelt de makkelijkste dingen om te doen bij De Zilte Zee zonder ingewikkelde planning.',
        activitiesLabel: 'Activiteiten & ideeën',
        activitiesTitle: 'Wat te doen nabij De Zilte Zee',
        gridSub: 'Alle aanbevelingen zijn makkelijk te combineren met een verblijf in De Zilte Zee in het vakantiepark in Bredene. Voeg gerust eigen foto’s toe aan elke kaart wanneer je die hebt.',
        lagoImgAlt: 'LAGO Bredene Grasduinen zwembad en recreatiecentrum',
        lagoTag: 'Zwemmen & gezinsplezier',
        lagoTitle: 'LAGO Bredene Grasduinen',
        lagoCopy1: 'Een van de makkelijkste gezinsactiviteiten vlak bij De Zilte Zee. Een modern zwem- en recreatiecentrum met waterspel voor kinderen, binnenspeeltuin, buitenbaden, sauna en bistro. Een praktische keuze op een regenachtige dag of wanneer kinderen eens iets anders willen dan het strand.',
        ...
        beachImgAlt: 'Het strand en de duinen nabij De Zilte Zee in Bredene',
        beachTag: 'Strand & natuur',
        beachTitle: 'Strand en duinen',
        beachCopy: 'Bredene staat bekend om zijn natuurlijke strand en duinen — perfect voor rustige ochtenden, lange wandelingen, zandkastelen en frisse zeelucht. Vanuit De Zilte Zee wordt strandtijd makkelijk deel van je dagelijkse ritme, zonder auto of groot plan.',
        beachFact1: '<strong>Ideaal voor:</strong> Alle leeftijden, wandelingen, ontspannen, gezinnen',
        beachFact2: '<strong>Afstand:</strong> Korte wandeling vanaf De Zilte Zee',
        cyclingImgAlt: 'Fietsroutes nabij Bredene en de Belgische kust',
        cyclingTag: 'Fietsen & wandelen',
        cyclingTitle: 'Fietsen en wandelen',
        cyclingCopy: 'De Belgische kust verken je makkelijk met de fiets of te voet. Vanuit De Zilte Zee kunnen gasten op hun eigen tempo routes door Bredene, de duinen en nabijgelegen kustplaatsen volgen — een korte gezinswandeling, een langere fietstocht of een mooie route richting zee.',
        ...
        ostendFact2: '<strong>Afstand:</strong> Korte rit met de auto of fiets vanaf De Zilte Zee',
        ...
        dehaanCopy: 'De Haan staat bekend om zijn charmante kustsfeer en Belle Époque-villa’s. Een goede keuze wanneer je eens een andere omgeving wilt zonder de dag ingewikkeld te maken. Geniet van een wandeling, een drankje, een maaltijd of gewoon een andere kustsfeer voor je terugkeert naar De Zilte Zee.',
        ...
        tourismCopy2: 'Deze link is vooral handig voor actuele dingen om te doen in Bredene die doorheen het jaar veranderen, terwijl deze pagina de meest praktische opties bundelt voor gasten die in De Zilte Zee verblijven.',
        tourismLink: 'Bezoek de officiële toeristische website van Bredene',
        ctaLabel: 'Verblijf in De Zilte Zee',
        ctaTitle: 'Maak van Bredene je vakantiebasis',
        ctaCopy: 'Verblijf in De Zilte Zee en geniet van een vakantiehuis in het hart van Bredene, dicht bij strand, zwemmen, eten en drinken, gezinsactiviteiten en eenvoudige uitstappen langs de Belgische kust.'
      },
      bookingDynamic: {
    ...
    fr: {
      meta: {
        homeTitle: 'De Zilte Zee - Maison de vacances à la côte belge',
        homeDescription: 'De Zilte Zee - une belle maison de vacances à la côte belge. Chien admis, jardin privé, parking et accès à la piscine. Réservez votre séjour.',
        bookingTitle: 'Réserver votre séjour - De Zilte Zee',
        bookingDescription: 'Consultez les disponibilités et envoyez une demande de réservation pour la maison de vacances De Zilte Zee à Bredene.',
        thingsTitle: 'Que faire près de De Zilte Zee à Bredene | Côte belge',
        thingsDescription: 'Découvrez les activités près de De Zilte Zee dans le parc de vacances à Bredene, dont la nouvelle piscine LAGO Bredene Grasduinen, les plages, les dunes et les sorties familiales à la côte belge.'
      },
      common: {
        ...
        menuLabel: 'Menu',
        footer: '2025 De Zilte Zee · Maison de vacances à la côte belge · Tous droits réservés',
      ...
      home: {
        ...
        houseCopy1: 'De Zilte Zee est une charmante maison de vacances située dans un domaine paisible, à deux pas de la côte belge. Avec son atmosphère chaleureuse et ses équipements pratiques, c’est un refuge idéal pour familles, couples et amis — compagnons à quatre pattes bienvenus.',
        ...
        maxGuests: 'Pers. max.',
        beachAlt: 'La plage près de De Zilte Zee, à quelques minutes',
        amenitiesLabel: 'Équipements',
        amenitiesTitle: 'Tout ce qu’il faut',
        amenitiesSub: 'De Zilte Zee est équipée et prête pour vous permettre de vraiment déconnecter.',
        ...
        parkCopy: 'Le parc de vacances dispose de sa propre piscine chauffée et d’un restaurant — pas besoin d’aller loin.',
        parkPoolAlt: 'Piscine extérieure chauffée au parc de vacances',
        ...
        gallerySub: 'Quelques images de l’atmosphère qui vous attend à De Zilte Zee.',
        galleryBeachAlt: 'La plage près de De Zilte Zee',
        galleryDunesAlt: 'Les dunes près de De Zilte Zee',
        comingSoon: '📷 Bientôt',
        ...
        locationCopy: 'De Zilte Zee se trouve dans le parc de vacances à Bredene, près de la côte belge. L’adresse exacte est communiquée lors de la confirmation de réservation.',
      ...
      things: {
        ...
        heroTitle: 'Que faire près de De Zilte Zee',
        heroCopy: 'Notre maison de vacances De Zilte Zee dans le parc de vacances se trouve au cœur de Bredene — une base détendue pour les journées à la plage, les activités en famille, les repas et les excursions faciles le long de la côte belge.',
        guideLabel: 'Guide local',
        guideTitle: 'Une maison de vacances au cœur de Bredene',
        guideCopy: 'Que vous voyagiez avec des enfants, prépariez une pause tranquille à la côte ou cherchiez des activités faciles près de votre maison de vacances à Bredene, De Zilte Zee vous place près de nombreuses options pratiques et agréables.',
        guideCopy2: 'De la natation et des activités familiales à une excursion culturelle à Ostende, un repas dans le parc de vacances ou une matinée calme dans les dunes — ce guide rassemble les choses les plus simples à faire près de De Zilte Zee sans itinéraire compliqué.',
        activitiesLabel: 'Activités & idées',
        activitiesTitle: 'Que faire près de De Zilte Zee',
        gridSub: 'Toutes les recommandations se combinent facilement avec un séjour à De Zilte Zee dans le parc de vacances à Bredene. Ajoutez vos propres photos à chaque carte lorsque vous en avez.',
        lagoImgAlt: 'Piscine et centre de loisirs LAGO Bredene Grasduinen',
        lagoTag: 'Piscine & plaisir en famille',
        lagoTitle: 'LAGO Bredene Grasduinen',
        lagoCopy1: 'L’une des activités familiales les plus faciles près de De Zilte Zee. Un centre moderne de natation et de loisirs avec jeux d’eau pour enfants, aire de jeux intérieure, bassins extérieurs, sauna et bistro. Un choix pratique par temps de pluie ou lorsque les enfants veulent changer de la plage.',
        ...
        beachImgAlt: 'La plage et les dunes près de De Zilte Zee à Bredene',
        beachTag: 'Plage & nature',
        beachTitle: 'Plage et dunes',
        beachCopy: 'Bredene est connue pour sa plage naturelle et ses dunes — parfaites pour les matinées lentes, les longues promenades, les châteaux de sable et l’air marin. Depuis De Zilte Zee, la plage s’intègre facilement au rythme quotidien, sans voiture ni grand plan.',
        beachFact1: '<strong>Idéal pour :</strong> Tous les âges, promenades, détente, familles',
        beachFact2: '<strong>Distance :</strong> Courte promenade depuis De Zilte Zee',
        ...
        ostendFact2: '<strong>Distance :</strong> Court trajet en voiture ou à vélo depuis De Zilte Zee',
        ...
        tourismCopy2: 'Ce lien est particulièrement utile pour les choses à faire à Bredene qui changent au fil de l’année, tandis que cette page reprend les options les plus pratiques pour les hôtes séjournant à De Zilte Zee.',
        tourismLink: 'Visiter le site touristique officiel de Bredene',
        ctaLabel: 'Séjourner à De Zilte Zee',
        ctaTitle: 'Faites de Bredene votre base de vacances',
        ctaCopy: 'Séjournez à De Zilte Zee et profitez d’une maison de vacances au cœur de Bredene, près de la plage, de la piscine, des restaurants, des activités familiales et des excursions faciles le long de la côte belge.'
      },
      bookingDynamic: {
    ...
    de: {
      meta: {
        homeTitle: 'De Zilte Zee - Ferienhaus an der belgischen Küste',
        homeDescription: 'De Zilte Zee - ein schönes Ferienhaus an der belgischen Küste. Hundefreundlich, privater Garten, Parkplatz und Zugang zum Pool. Buchen Sie Ihren Aufenthalt.',
        bookingTitle: 'Aufenthalt buchen - De Zilte Zee',
        bookingDescription: 'Prüfen Sie die Verfügbarkeit und senden Sie eine Buchungsanfrage für das Ferienhaus De Zilte Zee in Bredene.',
        thingsTitle: 'Aktivitäten in der Nähe von De Zilte Zee in Bredene | Belgische Küste',
        thingsDescription: 'Entdecken Sie Aktivitäten bei De Zilte Zee im Ferienpark in Bredene, darunter das neue Schwimmbad LAGO Bredene Grasduinen, Strände, Dünen und familienfreundliche Ausflüge an der belgischen Küste.'
      },
      common: {
        ...
        menuLabel: 'Menü',
        footer: '2025 De Zilte Zee · Ferienhaus an der belgischen Küste · Alle Rechte vorbehalten',
      ...
      home: {
        ...
        houseCopy1: 'De Zilte Zee ist ein charmantes Ferienhaus in einer ruhigen Ferienanlage, nur wenige Schritte von der belgischen Küste entfernt. Mit warmer Atmosphäre und praktischer Ausstattung ist es ideal für Familien, Paare und Freunde — vierbeinige Begleiter sind ebenfalls willkommen.',
        ...
        bathroom: 'Bad',
        maxGuests: 'Max. Gäste',
        beachAlt: 'Der Strand bei De Zilte Zee, nur wenige Minuten entfernt',
        amenitiesLabel: 'Ausstattung',
        amenitiesTitle: 'Alles, was Sie brauchen',
        amenitiesSub: 'De Zilte Zee ist ausgestattet und bereit, damit Sie wirklich abschalten können.',
        ...
        parkCopy: 'Der Ferienpark hat einen eigenen beheizten Pool und ein Restaurant — Sie müssen nicht weit gehen.',
        parkPoolAlt: 'Beheizter Außenpool im Ferienpark',
        ...
        gallerySub: 'Ein paar Eindrücke von dem, was Sie bei De Zilte Zee erwartet.',
        galleryBeachAlt: 'Der Strand bei De Zilte Zee',
        galleryDunesAlt: 'Dünen bei De Zilte Zee',
        comingSoon: '📷 Demnächst',
        galleryNote: 'Fotos vom Haus folgen bald. Der Strand ist nur wenige Minuten entfernt.',
        locationLabel: 'Lage',
        locationTitle: 'Wo Sie uns finden',
        locationCopy: 'De Zilte Zee liegt im Ferienpark in Bredene, nahe der belgischen Küste. Die genaue Adresse erhalten Sie mit der Buchungsbestätigung.',
      ...
      things: {
        ...
        heroTitle: 'Aktivitäten in der Nähe von De Zilte Zee',
        heroCopy: 'Unser Ferienhaus De Zilte Zee im Ferienpark liegt im Herzen von Bredene — ein entspannter Ausgangspunkt für Strandtage, Familienaktivitäten, Essen und Trinken sowie einfache Ausflüge entlang der belgischen Küste.',
        guideLabel: 'Lokaler Guide',
        guideTitle: 'Ein Ferienhaus im Herzen von Bredene',
        guideCopy: 'Ob Sie mit Kindern reisen, eine entspannte Küstenpause planen oder einfache Aktivitäten nahe Ihrem Ferienhaus in Bredene suchen: Von De Zilte Zee aus sind viele praktische und schöne Möglichkeiten in der Umgebung schnell erreichbar.',
        guideCopy2: 'Vom Schwimmen und Familienspaß über einen kulturellen Ausflug nach Ostende bis zu einem Essen im Ferienpark oder einem ruhigen Morgen in den Dünen — dieser Guide bündelt die einfachsten Aktivitäten nahe De Zilte Zee ohne komplizierte Planung.',
        activitiesLabel: 'Aktivitäten & Ideen',
        activitiesTitle: 'Was tun nahe De Zilte Zee',
        gridSub: 'Alle Empfehlungen lassen sich leicht mit einem Aufenthalt in De Zilte Zee im Ferienpark in Bredene kombinieren. Fügen Sie jeder Karte eigene Fotos hinzu, sobald Sie welche haben.',
        lagoImgAlt: 'LAGO Bredene Grasduinen Schwimm- und Freizeitzentrum',
        lagoTag: 'Schwimmen & Familienspaß',
        lagoTitle: 'LAGO Bredene Grasduinen',
        lagoCopy1: 'Eine der einfachsten Familienaktivitäten nahe De Zilte Zee. Ein modernes Schwimm- und Freizeitzentrum mit Wasserspielbereich für Kinder, Indoor-Spielbereich, Außenbecken, Sauna und Bistro. Eine praktische Wahl an Regentagen oder wenn Kinder Abwechslung vom Strand möchten.',
        ...
        beachImgAlt: 'Strand und Dünen nahe De Zilte Zee in Bredene',
        beachTag: 'Strand & Natur',
        beachTitle: 'Strand und Dünen',
        beachCopy: 'Bredene ist für seinen natürlichen Strand und seine Dünen bekannt — perfekt für ruhige Morgen, lange Spaziergänge, Sandburgen und frische Meeresluft. Von De Zilte Zee aus wird Strandzeit leicht Teil des täglichen Rhythmus, ohne Auto oder großen Plan.',
        beachFact1: '<strong>Ideal für:</strong> Alle Altersgruppen, Spaziergänge, Entspannung, Familien',
        beachFact2: '<strong>Entfernung:</strong> Kurzer Spaziergang ab De Zilte Zee',
        ...
        cyclingCopy: 'Die belgische Küste lässt sich leicht mit dem Rad oder zu Fuß erkunden. Von De Zilte Zee aus können Gäste in ihrem eigenen Tempo Routen durch Bredene, die Dünen und nahe Küstenorte genießen — einen kurzen Familienspaziergang, eine längere Radtour oder eine schöne Strecke Richtung Meer.',
        ...
        ostendFact2: '<strong>Entfernung:</strong> Kurze Auto- oder Radfahrt ab De Zilte Zee',
        ...
        dehaanCopy: 'De Haan ist für seine charmante Küstenatmosphäre und Belle-Époque-Villen bekannt. Eine gute Option, wenn Sie eine andere Umgebung möchten und den Tag trotzdem einfach halten wollen. Genießen Sie einen Spaziergang, ein Getränk, eine Mahlzeit oder einfach ein anderes Küstengefühl, bevor Sie nach De Zilte Zee zurückkehren.',
        ...
        tourismCopy2: 'Dieser Link ist besonders hilfreich für aktuelle Aktivitäten in Bredene, die sich im Laufe des Jahres ändern, während diese Seite die praktischsten Optionen für Gäste in De Zilte Zee zusammenfasst.',
        tourismLink: 'Offizielle Tourismus-Website von Bredene besuchen',
        ctaLabel: 'Aufenthalt in De Zilte Zee',
        ctaTitle: 'Machen Sie Bredene zu Ihrer Urlaubsbasis',
        ctaCopy: 'Übernachten Sie in De Zilte Zee und genießen Sie ein Ferienhaus im Herzen von Bredene, nahe Strand, Schwimmen, Essen und Trinken, Familienaktivitäten und einfachen Ausflügen entlang der belgischen Küste.'
      },
      bookingDynamic: {
  ...
  var PAGE_RULES = {
    ...
    things: [
      ...
      ['.place-card:nth-child(1) img', 'things.lagoImgAlt', 'alt'],
      ['.place-card:nth-child(1) .card-tag', 'things.lagoTag'],
      ['.place-card:nth-child(1) h3', 'things.lagoTitle'],
      ['.place-card:nth-child(1) .card-body > p', 'things.lagoCopy1'],
      ['.place-card:nth-child(1) .card-facts li:nth-child(1)', 'things.lagoFact1', 'html'],
      ['.place-card:nth-child(1) .card-facts li:nth-child(2)', 'things.lagoFact2', 'html'],
      ['.place-card:nth-child(1) .card-facts li:nth-child(3)', 'things.lagoFact3', 'html'],
      ['.place-card:nth-child(1) .card-link', 'things.lagoLink'],
      ['.place-card:nth-child(2) img', 'things.fortImgAlt', 'alt'],
      ['.place-card:nth-child(2) .card-tag', 'things.fortTag'],
      ['.place-card:nth-child(2) h3', 'things.fortTitle'],
      ['.place-card:nth-child(2) .card-body > p', 'things.fortCopy'],
      ['.place-card:nth-child(2) .card-facts li:nth-child(1)', 'things.fortFact1', 'html'],
      ['.place-card:nth-child(2) .card-facts li:nth-child(2)', 'things.fortFact2', 'html'],
      ['.place-card:nth-child(2) .card-facts li:nth-child(3)', 'things.fortFact3', 'html'],
      ['.place-card:nth-child(2) .card-link', 'things.fortLink'],
      ['.place-card:nth-child(3) img', 'things.beachImgAlt', 'alt'],
      ['.place-card:nth-child(3) .card-tag', 'things.beachTag'],
      ['.place-card:nth-child(3) h3', 'things.beachTitle'],
      ['.place-card:nth-child(3) .card-body > p', 'things.beachCopy'],
      ['.place-card:nth-child(3) .card-facts li:nth-child(1)', 'things.beachFact1', 'html'],
      ['.place-card:nth-child(3) .card-facts li:nth-child(2)', 'things.beachFact2', 'html'],
      ['.place-card:nth-child(4) img', 'things.cyclingImgAlt', 'alt'],
      ['.place-card:nth-child(4) .card-tag', 'things.cyclingTag'],
      ['.place-card:nth-child(4) h3', 'things.cyclingTitle'],
      ['.place-card:nth-child(4) .card-body > p', 'things.cyclingCopy'],
      ['.place-card:nth-child(4) .card-facts li:nth-child(1)', 'things.cyclingFact1', 'html'],
      ['.place-card:nth-child(4) .card-facts li:nth-child(2)', 'things.cyclingFact2', 'html'],
      ['.place-card:nth-child(5) img', 'things.ostendImgAlt', 'alt'],
      ['.place-card:nth-child(5) .card-tag', 'things.ostendTag'],
      ['.place-card:nth-child(5) h3', 'things.ostendTitle'],
      ['.place-card:nth-child(5) .card-body > p', 'things.ostendCopy'],
      ['.place-card:nth-child(5) .card-facts li:nth-child(1)', 'things.ostendFact1', 'html'],
      ['.place-card:nth-child(5) .card-facts li:nth-child(2)', 'things.ostendFact2', 'html'],
      ['.place-card:nth-child(6) img', 'things.dehaanImgAlt', 'alt'],
      ['.place-card:nth-child(6) .card-tag', 'things.dehaanTag'],
      ['.place-card:nth-child(6) h3', 'things.dehaanTitle'],
      ['.place-card:nth-child(6) .card-body > p', 'things.dehaanCopy'],
      ['.place-card:nth-child(6) .card-facts li:nth-child(1)', 'things.dehaanFact1', 'html'],
      ['.place-card:nth-child(6) .card-facts li:nth-child(2)', 'things.dehaanFact2', 'html'],
  ...
  function applyLanguage(lang) {
    ...
    window.dispatchEvent(new CustomEvent('de-zilte-zee:languagechange', { detail: { lang: lang } }));
  }
