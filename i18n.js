  ...
  var COPY = {
    en: {
      ...
      home: {
        ...
        houseCopy1: 'Holiday Home NordHuys is a charming holiday home nestled within a peaceful vacation domain, just steps from the Belgian coastline. With its warm atmosphere and thoughtful amenities, it is the perfect retreat for families and couples seeking rest by the sea. Your dog is welcome too.',
        ...
        amenitiesSub: 'Holiday Home NordHuys is equipped and ready so you can truly switch off and enjoy.',
    ...
    nl: {
      ...
      home: {
        ...
        houseCopy1: 'Vakantiehuis NordHuys is een charmant vakantiehuis in een rustig vakantiedomein, vlak bij de Belgische kust. Met zijn warme sfeer en praktische voorzieningen is het de ideale plek voor gezinnen en koppels die rust zoeken aan zee. Ook uw hond is er van harte welkom.',
        ...
        amenitiesSub: 'Vakantiehuis NordHuys is uitgerust en klaar zodat je echt kunt ontspannen en genieten.',
    ...
    fr: {
      ...
      home: {
        ...
        houseCopy1: 'Maison de vacances NordHuys est une charmante maison de vacances située dans un domaine paisible, à deux pas de la côte belge. Avec son atmosphère chaleureuse et ses équipements pratiques, c\'est un refuge idéal pour les familles et les couples en quête de repos au bord de la mer. Votre chien est également le bienvenu.',
        ...
        amenitiesSub: 'Maison de vacances NordHuys est équipée et prête pour vous permettre de vraiment déconnecter.',
    ...
    de: {
      ...
      home: {
        ...
        houseCopy1: 'Ferienhaus NordHuys ist ein charmantes Ferienhaus in einer ruhigen Ferienanlage, nur wenige Schritte von der belgischen Küste entfernt. Mit warmer Atmosphäre und praktischer Ausstattung ist es ideal für Familien und Paare, die Erholung am Meer suchen. Auch Ihr Hund ist herzlich willkommen.',
        ...
        amenitiesSub: 'Ferienhaus NordHuys ist ausgestattet und bereit, damit Sie wirklich abschalten können.',
