  ...
  var COPY = {
    en: {
      ...
      home: {
        ...
        heroTagline: 'Wake up to the fresh scent of the sea, enjoy your first coffee in the garden, and let the day unfold naturally with a swim in the pool, a walk to the beach, and plenty of time for yourself and your family.',
        ...
        parkCopy: 'Zeewind II Holiday Park has its own heated pool and restaurant — no need to go anywhere.',
    ...
    nl: {
      ...
      home: {
        ...
        parkCopy: 'Vakantiepark Zeewind II heeft een eigen verwarmd zwembad en restaurant — je hoeft nergens heen.',
