  ...
  var COPY = {
    en: {
      ...
      booking: {
        ...
        calendarSub: 'Check-in and check-out are possible on Monday, Friday or Sunday, depending on the stay pattern.',
        ...
        pets: '🐶 Bringing a dog?',
        petNo: 'No dog',
        petSmall1: '🐾 Yes - 1 small dog (+€30)',
        petSmall2: '🐾🐾 Yes - 2 small dogs (+€45)',
        petBig1: '🐕 Yes - 1 big dog (+€45)',
        petHelp: 'Dog supplement: €30 for 1 small dog; €45 for 2 small dogs or 1 big dog.',
      ...
      bookingDynamic: {
        ...
        clickCheckin: 'Click a Monday, Friday or Sunday to choose your check-in. Click it again to clear your selection.',
        ...
        invalidCheckin: 'Check-in is only possible on Monday, Friday or Sunday on an available date.',
        invalidCheckout: 'Choose a valid check-out on Friday, Sunday or Monday.',
        ...
        block_short: 'Short weekend (Fri-Sun)',
        block_long: 'Long weekend (Fri-Mon)',
        block_sundayNight: 'Sunday night (Sun-Mon)',
        ...
        season_springHoliday: 'Spring holiday',
        season_mayJune: 'May-June',
        season_summerHigh: 'Summer High',
        season_summerPeak: 'Summer Peak',
        season_september: 'September',
        season_autumnHoliday: 'Autumn holiday',
        season_christmasNy: 'Christmas & New Year',
    ...
    nl: {
      ...
      booking: {
        ...
        calendarSub: 'Aankomst en vertrek zijn mogelijk op maandag, vrijdag of zondag, afhankelijk van de verblijfsformule.',
        ...
        petNo: 'Geen hond',
        petSmall1: '🐾 Ja - 1 kleine hond (+€30)',
        petSmall2: '🐾🐾 Ja - 2 kleine honden (+€45)',
        petBig1: '🐕 Ja - 1 grote hond (+€45)',
        petHelp: 'Hondentoeslag: €30 voor 1 kleine hond; €45 voor 2 kleine honden of 1 grote hond.',
      ...
      bookingDynamic: {
        ...
        clickCheckin: 'Klik op een maandag, vrijdag of zondag om je aankomst te kiezen. Klik opnieuw om je selectie te wissen.',
        ...
        invalidCheckin: 'Aankomst is alleen mogelijk op maandag, vrijdag of zondag op een beschikbare datum.',
        invalidCheckout: 'Kies een geldig vertrek op vrijdag, zondag of maandag.',
        ...
        block_short: 'Kort weekend (vr-zo)',
        block_long: 'Lang weekend (vr-ma)',
        block_sundayNight: 'Zondagnacht (zo-ma)',
        ...
        season_springHoliday: 'Paasvakantie',
        season_mayJune: 'Mei-juni',
        season_summerHigh: 'Zomer hoog',
        season_summerPeak: 'Zomer piek',
        season_september: 'September',
        season_autumnHoliday: 'Herfstvakantie',
        season_christmasNy: 'Kerst & nieuwjaar',
    ...
    fr: {
      ...
      booking: {
        ...
        calendarSub: 'Arrivée et départ possibles le lundi, le vendredi ou le dimanche, selon la formule de séjour.',
        ...
        petNo: 'Pas de chien',
        petSmall1: '🐾 Oui - 1 petit chien (+€30)',
        petSmall2: '🐾🐾 Oui - 2 petits chiens (+€45)',
        petBig1: '🐕 Oui - 1 grand chien (+€45)',
        petHelp: 'Supplément chien : €30 pour 1 petit chien ; €45 pour 2 petits chiens ou 1 grand chien.',
      ...
      bookingDynamic: {
        ...
        clickCheckin: 'Cliquez sur un lundi, vendredi ou dimanche pour choisir votre arrivée. Cliquez à nouveau pour effacer votre sélection.',
        ...
        invalidCheckin: 'L\'arrivée est possible uniquement le lundi, vendredi ou dimanche sur une date disponible.',
        invalidCheckout: 'Choisissez un départ valable le vendredi, dimanche ou lundi.',
        ...
        block_short: 'Court week-end (ven-dim)',
        block_long: 'Long week-end (ven-lun)',
        block_sundayNight: 'Nuit du dimanche (dim-lun)',
        ...
        season_springHoliday: 'Vacances de printemps',
        season_mayJune: 'Mai-juin',
        season_summerHigh: 'Haute saison été',
        season_summerPeak: 'Pic été',
        season_september: 'Septembre',
        season_autumnHoliday: 'Vacances d\'automne',
        season_christmasNy: 'Noël & Nouvel An',
    ...
    de: {
      ...
      booking: {
        ...
        calendarSub: 'An- und Abreise sind je nach Aufenthaltsform montags, freitags oder sonntags möglich.',
        ...
        petNo: 'Kein Hund',
        petSmall1: '🐾 Ja - 1 kleiner Hund (+€30)',
        petSmall2: '🐾🐾 Ja - 2 kleine Hunde (+€45)',
        petBig1: '🐕 Ja - 1 großer Hund (+€45)',
        petHelp: 'Hundezuschlag: €30 für 1 kleinen Hund; €45 für 2 kleine Hunde oder 1 großen Hund.',
      ...
      bookingDynamic: {
        ...
        clickCheckin: 'Klicken Sie auf einen Montag, Freitag oder Sonntag für Ihre Anreise. Klicken Sie erneut, um die Auswahl zu löschen.',
        ...
        invalidCheckin: 'Anreise ist nur montags, freitags oder sonntags an einem verfügbaren Datum möglich.',
        invalidCheckout: 'Wählen Sie eine gültige Abreise am Freitag, Sonntag oder Montag.',
        ...
        block_short: 'Kurzes Wochenende (Fr-So)',
        block_long: 'Langes Wochenende (Fr-Mo)',
        block_sundayNight: 'Sonntagnacht (So-Mo)',
        ...
        season_springHoliday: 'Frühlingsferien',
        season_mayJune: 'Mai-Juni',
        season_summerHigh: 'Sommer-Hochsaison',
        season_summerPeak: 'Sommer-Spitze',
        season_september: 'September',
        season_autumnHoliday: 'Herbstferien',
        season_christmasNy: 'Weihnachten & Neujahr',
