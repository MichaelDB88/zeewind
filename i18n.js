(function () {
  ...
  var COPY = {
    en: {
      meta: {
        homeTitle: 'Holiday Home NordHuys - Vacation Home at the Belgian Coast',
        homeDescription: 'Holiday Home NordHuys - a beautiful holiday home at the Belgian coast. Pet-friendly, private garden, parking, and access to pool. Book your stay today.',
        bookingTitle: 'Book Your Stay - Holiday Home NordHuys',
        bookingDescription: 'Check availability and send a booking request for Holiday Home NordHuys holiday home in Bredene.',
        thingsTitle: 'Things to Do Near Holiday Home NordHuys in Bredene | Belgian Coast',
        thingsDescription: 'Discover things to do near Holiday Home NordHuys in the holiday park in Bredene, including the new LAGO Bredene Grasduinen swimming pool, beaches, dunes, and family-friendly activities on the Belgian coast.',
        reviewsTitle: 'Guest Reviews | Holiday Home NordHuys',
        reviewsDescription: 'Read guest reviews and experiences from stays at Holiday Home NordHuys holiday home in Bredene.'
      },
      common: {
        navHouse: 'Our Home',
        ...
        menuLabel: 'Menu',
        footer: '© 2026 Holiday Home NordHuys <span>·</span> Holiday Home at the Belgian Coast <span>·</span> <a href="booking-terms.html">Booking Terms</a> <span>·</span> <a href="privacy-policy.html">Privacy Policy</a> <span>·</span> All rights reserved',
        checkAvailability: 'Check Availability'
      },
      home: {
        heroEyebrow: 'Bredene · Holiday Home by the Sea',
        heroTagline: 'Refined coastal living, just moments from the sea.',
        ...
        houseCopy1: 'Holiday Home NordHuys is a charming seaside retreat set within a peaceful vacation domain, just moments from the Belgian coastline. With its warm atmosphere, thoughtful amenities, and private garden, it offers the perfect setting for families, couples, and their four-legged companions to unwind by the sea.',
        houseCopy2: 'Start the day with coffee in the garden, spend relaxed afternoons by the shared pool, and end with a walk along the beach. At NordHuys, everything is in place for an effortless coastal escape.',
        bedrooms: 'Bedrooms',
        bathroom: 'Bathroom',
        maxGuests: 'Max Guests',
        beachAlt: 'The beach near Holiday Home NordHuys, just minutes away',
        amenitiesLabel: 'Amenities',
        amenitiesTitle: 'Everything you need',
        amenitiesSub: 'Fully equipped for a relaxed and carefree stay by the sea.',
        ...
        parkCopy: 'Located within Zeewind II Holiday Park, NordHuys offers easy access to a heated pool, tennis courts, a playground, and a range of on-site amenities for the whole family.',
        parkPoolAlt: 'Heated outdoor pool at Holiday Home NordHuys',
        ...
        gallerySub: 'A few glimpses of what awaits you at Holiday Home NordHuys.',
        galleryBeachAlt: 'The beach near Holiday Home NordHuys',
        galleryDunesAlt: 'Dunes near Holiday Home NordHuys',
        comingSoon: '📷 Coming soon',
        galleryNote: 'Photos of the house coming soon. The beach is just minutes away.',
        locationLabel: 'Location',
        locationTitle: 'Where to find us',
        locationCopy: 'Holiday Home NordHuys is located at the holiday park in Bredene, close to the Belgian coast. Exact address provided upon booking confirmation.',
      ...
      booking: {
        ...
        calendarSub: 'Check-in and check-out on Monday or Friday. In July and August: weekly stays from Saturday to Saturday. Minimum stay 3 nights, maximum 3 weeks.',
        legendAvailable: 'Available',
        legendBooked: 'Booked',
        legendSelection: 'Your selection',
        infoBox: '<strong>How it works:</strong> Choose your dates, add any extras, and send us your request. We check availability first and then reply with the next steps, usually within 24 hours. No payment is taken here.<br><br>Special requests or alternative dates in mind? Send us a request and we will gladly see what we can do.',
      ...
      things: {
        ...
        guideCopy: 'Whether you are travelling with children, planning a relaxed coastal break, or looking for easy activities close to your holiday home in Bredene, Holiday Home NordHuys puts you close to many of the area\'s most practical and enjoyable options.',
        guideCopy2: 'From swimming and family fun to a cultural day trip in Ostend, a meal inside the holiday park or a slow morning on the dunes — this guide covers the easiest things to do near Holiday Home NordHuys without needing to plan a complicated itinerary.',
        activitiesLabel: 'Activities & Ideas',
        activitiesTitle: 'What to do near Holiday Home NordHuys',
        ...
        lagoCopy1: 'One of the easiest family activities near Holiday Home NordHuys. A modern swimming and recreation centre with children\'s water play, indoor play area, outdoor pools, sauna and bistro. A practical choice on a rainy day or when children want a change from the beach.',
        ...
        beachImgAlt: 'The beach and dunes near Holiday Home NordHuys in Bredene',
        beachTag: 'Beach & Nature',
        beachTitle: 'Beach and dunes',
        beachCopy: 'Bredene is known for its natural beach and dunes — perfect for slow mornings, long walks, sandcastles and fresh sea air. From Holiday Home NordHuys, beach time can easily become part of your daily rhythm without needing a car or a plan.',
        beachFact1: '<strong>Best for:</strong> All ages, walks, relaxing, families',
        beachFact2: '<strong>Distance:</strong> Short walk from Holiday Home NordHuys',
        ...
        cyclingCopy: 'The Belgian coast is easy to explore by bike or on foot. From Holiday Home NordHuys, guests can enjoy routes through Bredene, the dunes and nearby coastal towns at their own pace — a short family walk, a longer bike ride, or a scenic route towards the sea.',
        ...
        ostendFact2: '<strong>Distance:</strong> A short drive or bike ride from Holiday Home NordHuys',
        ...
        dehaanCopy: 'De Haan is known for its charming coastal atmosphere and Belle Époque villas. A good option when you want a change of scenery while keeping the day simple. Enjoy a walk, a drink, a meal, or just the different coastal feeling before returning to Holiday Home NordHuys.',
        ...
        tourismCopy2: 'This link is especially helpful for up-to-date things to do in Bredene that change throughout the year, while this page covers the most practical options for guests staying at Holiday Home NordHuys.',
        tourismLink: 'Visit the official Bredene tourism website',
        ctaLabel: 'Stay at Holiday Home NordHuys',
        ctaTitle: 'Make Bredene your holiday base',
        ctaCopy: 'Stay at Holiday Home NordHuys and enjoy a holiday home in the heart of Bredene, close to the beach, swimming, food and drinks, family activities and easy day trips along the Belgian coast.'
      },
      bookingDynamic: {
        ...
        invalidCheckout: 'Choose a valid check-out on Monday or Friday (Saturday in July and August). Stays from 3 nights to 3 weeks.',
    ...
    nl: {
      meta: {
        homeTitle: 'Vakantiehuis NordHuys - Vakantiehuis aan de Belgische kust',
        homeDescription: 'Vakantiehuis NordHuys - een mooi vakantiehuis aan de Belgische kust. Hondvriendelijk, private tuin, parking en toegang tot zwembad. Boek vandaag je verblijf.',
        bookingTitle: 'Boek je verblijf - Vakantiehuis NordHuys',
        bookingDescription: 'Bekijk de beschikbaarheid en stuur een boekingsaanvraag voor vakantiehuis Vakantiehuis NordHuys in Bredene.',
        thingsTitle: 'Wat te doen in de buurt van Vakantiehuis NordHuys in Bredene | Belgische kust',
        thingsDescription: 'Ontdek wat er te doen is bij Vakantiehuis NordHuys in het vakantiepark in Bredene, inclusief het nieuwe LAGO Bredene Grasduinen zwembad, stranden, duinen en gezinsvriendelijke activiteiten aan de Belgische kust.',
        reviewsTitle: 'Gastbeoordelingen | Vakantiehuis NordHuys',
        reviewsDescription: 'Lees ervaringen en beoordelingen van gasten die verbleven in vakantiehuis Vakantiehuis NordHuys in Bredene.'
      },
      common: {
        navHouse: 'Ons huis',
        ...
        languageLabel: 'Taal',
        menuLabel: 'Menu',
        footer: '© 2026 Vakantiehuis NordHuys <span>·</span> Vakantiehuis aan de Belgische kust <span>·</span> <a href="booking-terms.html">Boekingsvoorwaarden</a> <span>·</span> <a href="privacy-policy.html">Privacybeleid</a> <span>·</span> Alle rechten voorbehouden',
        checkAvailability: 'Bekijk beschikbaarheid'
      },
      home: {
        heroEyebrow: 'Bredene · Vakantiehuis aan zee',
        heroTagline: 'Verfijnd kustleven, op een paar passen van de zee.',
        ...
        houseCopy1: 'Vakantiehuis NordHuys is een charmant kustverblijf in een rustig vakantiedomein, vlak bij de Belgische kust. Met zijn warme sfeer, doordachte voorzieningen en private tuin is het de perfecte plek voor gezinnen, koppels en hun viervoeters om tot rust te komen aan zee.',
        houseCopy2: 'Begin de dag met koffie in de tuin, geniet van ontspannen namiddagen aan het gedeelde zwembad en sluit af met een wandeling op het strand. Bij NordHuys staat alles klaar voor een zorgeloze vakantie aan de kust.',
        bedrooms: 'Slaapkamers',
        bathroom: 'Badkamer',
        maxGuests: 'Max. gasten',
        beachAlt: 'Het strand bij Vakantiehuis NordHuys, op slechts enkele minuten',
        amenitiesLabel: 'Voorzieningen',
        amenitiesTitle: 'Alles wat je nodig hebt',
        amenitiesSub: 'Volledig uitgerust voor een ontspannen en zorgeloos verblijf aan zee.',
        ...
        parkCopy: 'NordHuys ligt in vakantiepark Zeewind II en biedt vlotte toegang tot een verwarmd zwembad, tennisterreinen, een speeltuin en tal van voorzieningen op het domein voor het hele gezin.',
        parkPoolAlt: 'Verwarmd buitenzwembad bij Vakantiehuis NordHuys',
        ...
        gallerySub: 'Een paar beelden van wat je bij Vakantiehuis NordHuys mag verwachten.',
        galleryBeachAlt: 'Het strand bij Vakantiehuis NordHuys',
        galleryDunesAlt: 'Duinen bij Vakantiehuis NordHuys',
        ...
        locationCopy: 'Vakantiehuis NordHuys ligt in het vakantiepark in Bredene, dicht bij de Belgische kust. Het exacte adres krijg je bij de boekingsbevestiging.',
      ...
      booking: {
        ...
        calendarSub: 'Aankomst en vertrek op maandag of vrijdag. In juli en augustus: weekverhuur van zaterdag tot zaterdag. Minimumverblijf 3 nachten, maximum 3 weken.',
        legendAvailable: 'Beschikbaar',
        legendBooked: 'Geboekt',
        legendSelection: 'Jouw selectie',
        infoBox: '<strong>Zo werkt het:</strong> Kies je data, voeg eventuele extra\'s toe en stuur ons je aanvraag. We controleren eerst de beschikbaarheid en bezorgen je daarna de volgende stappen, meestal binnen 24 uur. Hier wordt nog geen betaling gevraagd.<br><br>Speciale wensen of andere data in gedachten? Stuur ons je aanvraag en we bekijken graag wat mogelijk is.',
      ...
      things: {
        ...
        guideCopy: 'Of je nu met kinderen reist, een ontspannen kustvakantie plant of leuke activiteiten zoekt dicht bij je vakantiehuis in Bredene: vanuit Vakantiehuis NordHuys zit je vlak bij veel praktische en aangename opties in de omgeving.',
        guideCopy2: 'Van zwemmen en gezinsplezier tot een culturele uitstap naar Oostende, een maaltijd in het vakantiepark of een rustige ochtend in de duinen — deze gids bundelt de makkelijkste dingen om te doen bij Vakantiehuis NordHuys zonder ingewikkelde planning.',
        activitiesLabel: 'Activiteiten & ideeën',
        activitiesTitle: 'Wat te doen nabij Vakantiehuis NordHuys',
        ...
        lagoTitle: 'LAGO Bredene Grasduinen',
        lagoCopy1: 'Een van de makkelijkste gezinsactiviteiten vlak bij Vakantiehuis NordHuys. Een modern zwem- en recreatiecentrum met waterspel voor kinderen, binnenspeeltuin, buitenbaden, sauna en bistro. Een praktische keuze op een regenachtige dag of wanneer kinderen eens iets anders willen dan het strand.',
        ...
        beachImgAlt: 'Het strand en de duinen nabij Vakantiehuis NordHuys in Bredene',
        beachTag: 'Strand & natuur',
        beachTitle: 'Strand en duinen',
        beachCopy: 'Bredene staat bekend om zijn natuurlijke strand en duinen — perfect voor rustige ochtenden, lange wandelingen, zandkastelen en frisse zeelucht. Vanuit Vakantiehuis NordHuys wordt strandtijd makkelijk deel van je dagelijkse ritme, zonder auto of groot plan.',
        beachFact1: '<strong>Ideaal voor:</strong> Alle leeftijden, wandelingen, ontspannen, gezinnen',
        beachFact2: '<strong>Afstand:</strong> Korte wandeling vanaf Vakantiehuis NordHuys',
        cyclingImgAlt: 'Fietsroutes nabij Bredene en de Belgische kust',
        cyclingTag: 'Fietsen & wandelen',
        cyclingTitle: 'Fietsen en wandelen',
        cyclingCopy: 'De Belgische kust verken je makkelijk met de fiets of te voet. Vanuit Vakantiehuis NordHuys kunnen gasten op hun eigen tempo routes door Bredene, de duinen en nabijgelegen kustplaatsen volgen — een korte gezinswandeling, een langere fietstocht of een mooie route richting zee.',
        ...
        ostendFact2: '<strong>Afstand:</strong> Korte rit met de auto of fiets vanaf Vakantiehuis NordHuys',
        ...
        dehaanCopy: 'De Haan staat bekend om zijn charmante kustsfeer en Belle Époque-villa\'s. Een goede keuze wanneer je eens een andere omgeving wilt zonder de dag ingewikkeld te maken. Geniet van een wandeling, een drankje, een maaltijd of gewoon een andere kustsfeer voor je terugkeert naar Vakantiehuis NordHuys.',
        ...
        tourismCopy2: 'Deze link is vooral handig voor actuele dingen om te doen in Bredene die doorheen het jaar veranderen, terwijl deze pagina de meest praktische opties bundelt voor gasten die in Vakantiehuis NordHuys verblijven.',
        tourismLink: 'Bezoek de officiële toeristische website van Bredene',
        ctaLabel: 'Verblijf in Vakantiehuis NordHuys',
        ctaTitle: 'Maak van Bredene je vakantiebasis',
        ctaCopy: 'Verblijf in Vakantiehuis NordHuys en geniet van een vakantiehuis in het hart van Bredene, dicht bij strand, zwemmen, eten en drinken, gezinsactiviteiten en eenvoudige uitstappen langs de Belgische kust.'
      },
      bookingDynamic: {
        ...
        invalidCheckout: 'Kies een geldig vertrek op maandag of vrijdag (zaterdag in juli en augustus). Verblijven van 3 nachten tot 3 weken.',
    ...
    fr: {
      meta: {
        homeTitle: 'Maison de vacances NordHuys - Maison de vacances à la côte belge',
        homeDescription: 'Maison de vacances NordHuys - une belle maison de vacances à la côte belge. Chien admis, jardin privé, parking et accès à la piscine. Réservez votre séjour.',
        bookingTitle: 'Réserver votre séjour - Maison de vacances NordHuys',
        bookingDescription: 'Consultez les disponibilités et envoyez une demande de réservation pour la maison de vacances Maison de vacances NordHuys à Bredene.',
        thingsTitle: 'Que faire près de Maison de vacances NordHuys à Bredene | Côte belge',
        thingsDescription: 'Découvrez les activités près de Maison de vacances NordHuys dans le parc de vacances à Bredene, dont la nouvelle piscine LAGO Bredene Grasduinen, les plages, les dunes et les sorties familiales à la côte belge.',
        reviewsTitle: 'Avis des voyageurs | Maison de vacances NordHuys',
        reviewsDescription: 'Lisez les avis et expériences des voyageurs ayant séjourné à Maison de vacances NordHuys, maison de vacances à Bredene.'
      },
      common: {
        ...
        menuLabel: 'Menu',
        footer: '© 2026 Maison de vacances NordHuys <span>·</span> Maison de vacances à la côte belge <span>·</span> <a href="booking-terms.html">Conditions de réservation</a> <span>·</span> <a href="privacy-policy.html">Politique de confidentialité</a> <span>·</span> Tous droits réservés',
        checkAvailability: 'Voir les disponibilités'
      },
      home: {
        heroEyebrow: 'Bredene · Maison de vacances au bord de la mer',
        heroTagline: 'Un séjour côtier raffiné, à quelques pas de la mer.',
        ...
        houseCopy1: 'Maison de vacances NordHuys est une charmante retraite balnéaire située dans un domaine paisible, à deux pas de la côte belge. Avec son atmosphère chaleureuse, ses équipements soignés et son jardin privé, elle offre le cadre idéal aux familles, aux couples et à leurs compagnons à quatre pattes pour se détendre au bord de la mer.',
        houseCopy2: 'Commencez la journée avec un café au jardin, profitez d\'après-midis détendus à la piscine commune et terminez par une promenade sur la plage. À NordHuys, tout est réuni pour une escapade côtière sans souci.',
        bedrooms: 'Chambres',
        bathroom: 'Salle de bain',
        maxGuests: 'Pers. max.',
        beachAlt: 'La plage près de Maison de vacances NordHuys, à quelques minutes',
        amenitiesLabel: 'Équipements',
        amenitiesTitle: 'Tout ce qu\'il faut',
        amenitiesSub: 'Entièrement équipée pour un séjour détendu et sans souci au bord de la mer.',
        ...
        parkCopy: 'Située au sein du Holiday Park Zeewind II, NordHuys offre un accès facile à une piscine chauffée, des terrains de tennis, une aire de jeux et de nombreux équipements sur place pour toute la famille.',
        parkPoolAlt: 'Piscine extérieure chauffée à Maison de vacances NordHuys',
        ...
        gallerySub: 'Quelques images de l\'atmosphère qui vous attend à Maison de vacances NordHuys.',
        galleryBeachAlt: 'La plage près de Maison de vacances NordHuys',
        galleryDunesAlt: 'Les dunes près de Maison de vacances NordHuys',
        comingSoon: '📷 Bientôt',
        ...
        locationCopy: 'Maison de vacances NordHuys se trouve dans le parc de vacances à Bredene, près de la côte belge. L\'adresse exacte est communiquée lors de la confirmation de réservation.',
      ...
      booking: {
        ...
        calendarSub: 'Arrivée et départ le lundi ou le vendredi. En juillet et août : location à la semaine du samedi au samedi. Séjour minimum 3 nuits, maximum 3 semaines.',
        legendAvailable: 'Disponible',
        legendBooked: 'Réservé',
        legendSelection: 'Votre sélection',
        infoBox: '<strong>Comment ça marche :</strong> Choisissez vos dates, ajoutez les options souhaitées et envoyez-nous votre demande. Nous vérifions d\'abord la disponibilité puis nous vous répondons avec les prochaines étapes, généralement sous 24 heures. Aucun paiement n\'est demandé ici.<br><br>Demandes particulières ou autres dates en tête ? Envoyez-nous votre demande et nous verrons volontiers ce qui est possible.',
      ...
      things: {
        ...
        guideCopy: 'Que vous voyagiez avec des enfants, prépariez une pause tranquille à la côte ou cherchiez des activités faciles près de votre maison de vacances à Bredene, Maison de vacances NordHuys vous place près de nombreuses options pratiques et agréables.',
        guideCopy2: 'De la natation et des activités familiales à une excursion culturelle à Ostende, un repas dans le parc de vacances ou une matinée calme dans les dunes — ce guide rassemble les choses les plus simples à faire près de Maison de vacances NordHuys sans itinéraire compliqué.',
        activitiesLabel: 'Activités & idées',
        activitiesTitle: 'Que faire près de Maison de vacances NordHuys',
        ...
        beachImgAlt: 'La plage et les dunes près de Maison de vacances NordHuys à Bredene',
        beachTag: 'Plage & nature',
        beachTitle: 'Plage et dunes',
        beachCopy: 'Bredene est connue pour sa plage naturelle et ses dunes — parfaites pour les matinées lentes, les longues promenades, les châteaux de sable et l\'air marin. Depuis Maison de vacances NordHuys, la plage s\'intègre facilement au rythme quotidien, sans voiture ni grand plan.',
        beachFact1: '<strong>Idéal pour :</strong> Tous les âges, promenades, détente, familles',
        beachFact2: '<strong>Distance :</strong> Courte promenade depuis Maison de vacances NordHuys',
        ...
        ostendFact2: '<strong>Distance :</strong> Court trajet en voiture ou à vélo depuis Maison de vacances NordHuys',
        ...
        tourismCopy2: 'Ce lien est particulièrement utile pour les choses à faire à Bredene qui changent au fil de l\'année, tandis que cette page reprend les options les plus pratiques pour les hôtes séjournant à Maison de vacances NordHuys.',
        tourismLink: 'Visiter le site touristique officiel de Bredene',
        ctaLabel: 'Séjourner à Maison de vacances NordHuys',
        ctaTitle: 'Faites de Bredene votre base de vacances',
        ctaCopy: 'Séjournez à Maison de vacances NordHuys et profitez d\'une maison de vacances au cœur de Bredene, près de la plage, de la piscine, des restaurants, des activités familiales et des excursions faciles le long de la côte belge.'
      },
      bookingDynamic: {
        ...
        invalidCheckout: 'Choisissez un départ valide le lundi ou le vendredi (samedi en juillet et août). Séjours de 3 nuits à 3 semaines.',
    ...
    de: {
      meta: {
        homeTitle: 'Ferienhaus NordHuys - Ferienhaus an der belgischen Küste',
        homeDescription: 'Ferienhaus NordHuys - ein schönes Ferienhaus an der belgischen Küste. Hundefreundlich, privater Garten, Parkplatz und Zugang zum Pool. Buchen Sie Ihren Aufenthalt.',
        bookingTitle: 'Aufenthalt buchen - Ferienhaus NordHuys',
        bookingDescription: 'Prüfen Sie die Verfügbarkeit und senden Sie eine Buchungsanfrage für das Ferienhaus Ferienhaus NordHuys in Bredene.',
        thingsTitle: 'Aktivitäten in der Nähe von Ferienhaus NordHuys in Bredene | Belgische Küste',
        thingsDescription: 'Entdecken Sie Aktivitäten bei Ferienhaus NordHuys im Ferienpark in Bredene, darunter das neue Schwimmbad LAGO Bredene Grasduinen, Strände, Dünen und familienfreundliche Ausflüge an der belgischen Küste.',
        reviewsTitle: 'Gästebewertungen | Ferienhaus NordHuys',
        reviewsDescription: 'Lesen Sie Bewertungen und Erfahrungen von Gästen des Ferienhauses Ferienhaus NordHuys in Bredene.'
      },
      common: {
        ...
        menuLabel: 'Menü',
        footer: '© 2026 Ferienhaus NordHuys <span>·</span> Ferienhaus an der belgischen Küste <span>·</span> <a href="booking-terms.html">Buchungsbedingungen</a> <span>·</span> <a href="privacy-policy.html">Datenschutzerklärung</a> <span>·</span> Alle Rechte vorbehalten',
        checkAvailability: 'Verfügbarkeit prüfen'
      },
      home: {
        heroEyebrow: 'Bredene · Ferienhaus am Meer',
        heroTagline: 'Gehobenes Küstenwohnen, nur wenige Schritte vom Meer entfernt.',
        ...
        houseCopy1: 'Ferienhaus NordHuys ist ein charmantes Refugium am Meer in einer ruhigen Ferienanlage, nur wenige Schritte von der belgischen Küste entfernt. Mit warmer Atmosphäre, durchdachter Ausstattung und privatem Garten bietet es Familien, Paaren und ihren vierbeinigen Begleitern den perfekten Rahmen, um am Meer zu entspannen.',
        houseCopy2: 'Beginnen Sie den Tag mit Kaffee im Garten, verbringen Sie entspannte Nachmittage am Gemeinschaftspool und lassen Sie den Abend mit einem Strandspaziergang ausklingen. Im NordHuys ist alles bereit für eine unbeschwerte Auszeit an der Küste.',
        bedrooms: 'Schlafzimmer',
        bathroom: 'Bad',
        maxGuests: 'Max. Gäste',
        beachAlt: 'Der Strand bei Ferienhaus NordHuys, nur wenige Minuten entfernt',
        amenitiesLabel: 'Ausstattung',
        amenitiesTitle: 'Alles, was Sie brauchen',
        amenitiesSub: 'Komplett ausgestattet für einen entspannten und unbeschwerten Aufenthalt am Meer.',
        ...
        parkCopy: 'Das NordHuys liegt im Holiday Park Zeewind II und bietet bequemen Zugang zu einem beheizten Pool, Tennisplätzen, einem Spielplatz und vielen weiteren Einrichtungen für die ganze Familie.',
        parkPoolAlt: 'Beheizter Außenpool bei Ferienhaus NordHuys',
        ...
        gallerySub: 'Ein paar Eindrücke von dem, was Sie bei Ferienhaus NordHuys erwartet.',
        galleryBeachAlt: 'Der Strand bei Ferienhaus NordHuys',
        galleryDunesAlt: 'Dünen bei Ferienhaus NordHuys',
        comingSoon: '📷 Demnächst',
        galleryNote: 'Fotos vom Haus folgen bald. Der Strand ist nur wenige Minuten entfernt.',
        locationLabel: 'Lage',
        locationTitle: 'Wo Sie uns finden',
        locationCopy: 'Ferienhaus NordHuys liegt im Ferienpark in Bredene, nahe der belgischen Küste. Die genaue Adresse erhalten Sie mit der Buchungsbestätigung.',
      ...
      booking: {
        ...
        calendarSub: 'An- und Abreise montags oder freitags. Im Juli und August: Wochenmiete von Samstag bis Samstag. Mindestaufenthalt 3 Nächte, maximal 3 Wochen.',
        legendAvailable: 'Verfügbar',
        legendBooked: 'Gebucht',
        legendSelection: 'Ihre Auswahl',
        infoBox: '<strong>So funktioniert es:</strong> Wählen Sie Ihre Daten, fügen Sie gewünschte Extras hinzu und senden Sie uns Ihre Anfrage. Wir prüfen zuerst die Verfügbarkeit und melden uns dann mit den nächsten Schritten, normalerweise innerhalb von 24 Stunden. Hier wird noch keine Zahlung vorgenommen.<br><br>Besondere Wünsche oder andere Daten im Sinn? Senden Sie uns Ihre Anfrage und wir prüfen gerne, was möglich ist.',
      ...
      things: {
        ...
        guideCopy: 'Ob Sie mit Kindern reisen, eine entspannte Küstenpause planen oder einfache Aktivitäten nahe Ihrem Ferienhaus in Bredene suchen: Von Ferienhaus NordHuys aus sind viele praktische und schöne Möglichkeiten in der Umgebung schnell erreichbar.',
        guideCopy2: 'Vom Schwimmen und Familienspaß über einen kulturellen Ausflug nach Ostende bis zu einem Essen im Ferienpark oder einem ruhigen Morgen in den Dünen — dieser Guide bündelt die einfachsten Aktivitäten nahe Ferienhaus NordHuys ohne komplizierte Planung.',
        activitiesLabel: 'Aktivitäten & Ideen',
        activitiesTitle: 'Was tun nahe Ferienhaus NordHuys',
        ...
        lagoTitle: 'LAGO Bredene Grasduinen',
        lagoCopy1: 'Eine der einfachsten Familienaktivitäten nahe Ferienhaus NordHuys. Ein modernes Schwimm- und Freizeitzentrum mit Wasserspielbereich für Kinder, Indoor-Spielbereich, Außenbecken, Sauna und Bistro. Eine praktische Wahl an Regentagen oder wenn Kinder Abwechslung vom Strand möchten.',
        ...
        beachImgAlt: 'Strand und Dünen nahe Ferienhaus NordHuys in Bredene',
        beachTag: 'Strand & Natur',
        beachTitle: 'Strand und Dünen',
        beachCopy: 'Bredene ist für seinen natürlichen Strand und seine Dünen bekannt — perfekt für ruhige Morgen, lange Spaziergänge, Sandburgen und frische Meeresluft. Von Ferienhaus NordHuys aus wird Strandzeit leicht Teil des täglichen Rhythmus, ohne Auto oder großen Plan.',
        beachFact1: '<strong>Ideal für:</strong> Alle Altersgruppen, Spaziergänge, Entspannung, Familien',
        beachFact2: '<strong>Entfernung:</strong> Kurzer Spaziergang ab Ferienhaus NordHuys',
        ...
        cyclingCopy: 'Die belgische Küste lässt sich leicht mit dem Rad oder zu Fuß erkunden. Von Ferienhaus NordHuys aus können Gäste in ihrem eigenen Tempo Routen durch Bredene, die Dünen und nahe Küstenorte genießen — einen kurzen Familienspaziergang, eine längere Radtour oder eine schöne Strecke Richtung Meer.',
        ...
        ostendFact2: '<strong>Entfernung:</strong> Kurze Auto- oder Radfahrt ab Ferienhaus NordHuys',
        ...
        dehaanCopy: 'De Haan ist für seine charmante Küstenatmosphäre und Belle-Époque-Villen bekannt. Eine gute Option, wenn Sie eine andere Umgebung möchten und den Tag trotzdem einfach halten wollen. Genießen Sie einen Spaziergang, ein Getränk, eine Mahlzeit oder einfach ein anderes Küstengefühl, bevor Sie nach Ferienhaus NordHuys zurückkehren.',
        ...
        tourismCopy2: 'Dieser Link ist besonders hilfreich für aktuelle Aktivitäten in Bredene, die sich im Laufe des Jahres ändern, während diese Seite die praktischsten Optionen für Gäste in Ferienhaus NordHuys zusammenfasst.',
        tourismLink: 'Offizielle Tourismus-Website von Bredene besuchen',
        ctaLabel: 'Aufenthalt in Ferienhaus NordHuys',
        ctaTitle: 'Machen Sie Bredene zu Ihrer Urlaubsbasis',
        ctaCopy: 'Übernachten Sie in Ferienhaus NordHuys und genießen Sie ein Ferienhaus im Herzen von Bredene, nahe Strand, Schwimmen, Essen und Trinken, Familienaktivitäten und einfachen Ausflügen entlang der belgischen Küste.'
      },
      bookingDynamic: {
        ...
        invalidCheckout: 'Wählen Sie eine gültige Abreise am Montag oder Freitag (Samstag im Juli und August). Aufenthalte von 3 Nächten bis 3 Wochen.',
  ...
  var PAGE_RULES = {
    home: [
      ...
      ['#gallery img[src="beach1.jpg"]', 'home.galleryBeachAlt', 'alt'],
      ['#gallery img[src="beach2.jpg"]', 'home.galleryDunesAlt', 'alt'],
