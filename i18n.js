  ...
  var COPY = {
    en: {
      ...
      home: {
        ...
        parkPoolAlt: 'Heated outdoor pool at Zeewind II',
      ...
      things: {
        ...
        guideCopy: 'Whether you are travelling with children, planning a relaxed coastal break, or looking for easy activities close to your holiday home in Bredene, Zeewind II puts you close to many of the area\'s most practical and enjoyable options.',
        guideCopy2: 'From swimming and family fun to a cultural day trip in Ostend, a meal inside the holiday park or a slow morning on the dunes — this guide covers the easiest things to do near Zeewind II without needing to plan a complicated itinerary.',
        activitiesLabel: 'Activities & Ideas',
        activitiesTitle: 'What to do near Zeewind II',
        ...
        lagoCopy1: 'One of the easiest family activities near Zeewind II. A modern swimming and recreation centre with children\'s water play, indoor play area, outdoor pools, sauna and bistro. A practical choice on a rainy day or when children want a change from the beach.',
        ...
        beachImgAlt: 'The beach and dunes near Zeewind II in Bredene',
        beachTag: 'Beach & Nature',
        beachTitle: 'Beach and dunes',
        beachCopy: 'Bredene is known for its natural beach and dunes — perfect for slow mornings, long walks, sandcastles and fresh sea air. From Zeewind II, beach time can easily become part of your daily rhythm without needing a car or a plan.',
        beachFact1: '<strong>Best for:</strong> All ages, walks, relaxing, families',
        beachFact2: '<strong>Distance:</strong> Short walk from Zeewind II',
        ...
        cyclingCopy: 'The Belgian coast is easy to explore by bike or on foot. From Zeewind II, guests can enjoy routes through Bredene, the dunes and nearby coastal towns at their own pace — a short family walk, a longer bike ride, or a scenic route towards the sea.',
        ...
        ostendFact2: '<strong>Distance:</strong> A short drive or bike ride from Zeewind II',
        ...
        dehaanCopy: 'De Haan is known for its charming coastal atmosphere and Belle Époque villas. A good option when you want a change of scenery while keeping the day simple. Enjoy a walk, a drink, a meal, or just the different coastal feeling before returning to Zeewind II.',
        ...
        tourismCopy2: 'This link is especially helpful for up-to-date things to do in Bredene that change throughout the year, while this page covers the most practical options for guests staying at Zeewind II.',
        tourismLink: 'Visit the official Bredene tourism website',
        ctaLabel: 'Stay at Zeewind',
        ctaTitle: 'Make Bredene your holiday base',
        ctaCopy: 'Stay at Zeewind II and enjoy a holiday home in the heart of Bredene, close to the beach, swimming, food and drinks, family activities and easy day trips along the Belgian coast.'
      },
      bookingDynamic: {
    ...
    nl: {
      ...
      home: {
        ...
        parkPoolAlt: 'Verwarmd buitenzwembad bij Zeewind II',
      ...
      things: {
        ...
        guideCopy: 'Of je nu met kinderen reist, een ontspannen kustvakantie plant of leuke activiteiten zoekt dicht bij je vakantiehuis in Bredene: vanuit Zeewind II zit je vlak bij veel praktische en aangename opties in de omgeving.',
        guideCopy2: 'Van zwemmen en gezinsplezier tot een culturele uitstap naar Oostende, een maaltijd in het vakantiepark of een rustige ochtend in de duinen — deze gids bundelt de makkelijkste dingen om te doen bij Zeewind II zonder ingewikkelde planning.',
        activitiesLabel: 'Activiteiten & ideeën',
        activitiesTitle: 'Wat te doen nabij Zeewind II',
        ...
        lagoTitle: 'LAGO Bredene Grasduinen',
        lagoCopy1: 'Een van de makkelijkste gezinsactiviteiten vlak bij Zeewind II. Een modern zwem- en recreatiecentrum met waterspel voor kinderen, binnenspeeltuin, buitenbaden, sauna en bistro. Een praktische keuze op een regenachtige dag of wanneer kinderen eens iets anders willen dan het strand.',
        ...
        beachImgAlt: 'Het strand en de duinen nabij Zeewind II in Bredene',
        beachTag: 'Strand & natuur',
        beachTitle: 'Strand en duinen',
        beachCopy: 'Bredene staat bekend om zijn natuurlijke strand en duinen — perfect voor rustige ochtenden, lange wandelingen, zandkastelen en frisse zeelucht. Vanuit Zeewind II wordt strandtijd makkelijk deel van je dagelijkse ritme, zonder auto of groot plan.',
        beachFact1: '<strong>Ideaal voor:</strong> Alle leeftijden, wandelingen, ontspannen, gezinnen',
        beachFact2: '<strong>Afstand:</strong> Korte wandeling vanaf Zeewind II',
        cyclingImgAlt: 'Fietsroutes nabij Bredene en de Belgische kust',
        cyclingTag: 'Fietsen & wandelen',
        cyclingTitle: 'Fietsen en wandelen',
        cyclingCopy: 'De Belgische kust verken je makkelijk met de fiets of te voet. Vanuit Zeewind II kunnen gasten op hun eigen tempo routes door Bredene, de duinen en nabijgelegen kustplaatsen volgen — een korte gezinswandeling, een langere fietstocht of een mooie route richting zee.',
        ...
        ostendFact2: '<strong>Afstand:</strong> Korte rit met de auto of fiets vanaf Zeewind II',
        ...
        dehaanCopy: 'De Haan staat bekend om zijn charmante kustsfeer en Belle Époque-villa’s. Een goede keuze wanneer je eens een andere omgeving wilt zonder de dag ingewikkeld te maken. Geniet van een wandeling, een drankje, een maaltijd of gewoon een andere kustsfeer voor je terugkeert naar Zeewind II.',
        ...
        tourismCopy2: 'Deze link is vooral handig voor actuele dingen om te doen in Bredene die doorheen het jaar veranderen, terwijl deze pagina de meest praktische opties bundelt voor gasten die in Zeewind II verblijven.',
        ...
        ctaCopy: 'Verblijf in Zeewind II en geniet van een vakantiehuis in het hart van Bredene, dicht bij strand, zwemmen, eten en drinken, gezinsactiviteiten en eenvoudige uitstappen langs de Belgische kust.'
      },
      bookingDynamic: {
    ...
    fr: {
      ...
      home: {
        ...
        parkPoolAlt: 'Piscine extérieure chauffée à Zeewind II',
      ...
      things: {
        ...
        guideCopy: 'Que vous voyagiez avec des enfants, prépariez une pause tranquille à la côte ou cherchiez des activités faciles près de votre maison de vacances à Bredene, Zeewind II vous place près de nombreuses options pratiques et agréables.',
        guideCopy2: 'De la natation et des activités familiales à une excursion culturelle à Ostende, un repas dans le parc de vacances ou une matinée calme dans les dunes — ce guide rassemble les choses les plus simples à faire près de Zeewind II sans itinéraire compliqué.',
        activitiesLabel: 'Activités & idées',
        activitiesTitle: 'Que faire près de Zeewind II',
        ...
        lagoTitle: 'LAGO Bredene Grasduinen',
        lagoCopy1: 'L’une des activités familiales les plus faciles près de Zeewind II. Un centre moderne de natation et de loisirs avec jeux d’eau pour enfants, aire de jeux intérieure, bassins extérieurs, sauna et bistro. Un choix pratique par temps de pluie ou lorsque les enfants veulent changer de la plage.',
        ...
        beachImgAlt: 'La plage et les dunes près de Zeewind II à Bredene',
        beachTag: 'Plage & nature',
        beachTitle: 'Plage et dunes',
        beachCopy: 'Bredene est connue pour sa plage naturelle et ses dunes — parfaites pour les matinées lentes, les longues promenades, les châteaux de sable et l’air marin. Depuis Zeewind II, la plage s’intègre facilement au rythme quotidien, sans voiture ni grand plan.',
        beachFact1: '<strong>Idéal pour :</strong> Tous les âges, promenades, détente, familles',
        beachFact2: '<strong>Distance :</strong> Courte promenade depuis Zeewind II',
        ...
        cyclingCopy: 'La côte belge se découvre facilement à vélo ou à pied. Depuis Zeewind II, les hôtes peuvent suivre à leur rythme des itinéraires à travers Bredene, les dunes et les communes côtières voisines — une courte promenade en famille, une plus longue balade à vélo ou un trajet panoramique vers la mer.',
        ...
        ostendFact2: '<strong>Distance :</strong> Court trajet en voiture ou à vélo depuis Zeewind II',
        ...
        tourismCopy2: 'Ce lien est particulièrement utile pour les choses à faire à Bredene qui changent au fil de l’année, tandis que cette page reprend les options les plus pratiques pour les hôtes séjournant à Zeewind II.',
        ...
        ctaCopy: 'Séjournez à Zeewind II et profitez d’une maison de vacances au cœur de Bredene, près de la plage, de la piscine, des restaurants, des activités familiales et des excursions faciles le long de la côte belge.'
      },
      bookingDynamic: {
    ...
    de: {
      ...
      home: {
        ...
        parkPoolAlt: 'Beheizter Außenpool bei Zeewind II',
      ...
      things: {
        ...
        guideCopy: 'Ob Sie mit Kindern reisen, eine entspannte Küstenpause planen oder einfache Aktivitäten nahe Ihrem Ferienhaus in Bredene suchen: Von Zeewind II aus sind viele praktische und schöne Möglichkeiten in der Umgebung schnell erreichbar.',
        guideCopy2: 'Vom Schwimmen und Familienspaß über einen kulturellen Ausflug nach Ostende bis zu einem Essen im Ferienpark oder einem ruhigen Morgen in den Dünen — dieser Guide bündelt die einfachsten Aktivitäten nahe Zeewind II ohne komplizierte Planung.',
        activitiesLabel: 'Aktivitäten & Ideen',
        activitiesTitle: 'Was tun nahe Zeewind II',
        ...
        lagoTitle: 'LAGO Bredene Grasduinen',
        lagoCopy1: 'Eine der einfachsten Familienaktivitäten nahe Zeewind II. Ein modernes Schwimm- und Freizeitzentrum mit Wasserspielbereich für Kinder, Indoor-Spielbereich, Außenbecken, Sauna und Bistro. Eine praktische Wahl an Regentagen oder wenn Kinder Abwechslung vom Strand möchten.',
        ...
        beachImgAlt: 'Strand und Dünen nahe Zeewind II in Bredene',
        beachTag: 'Strand & Natur',
        beachTitle: 'Strand und Dünen',
        beachCopy: 'Bredene ist für seinen natürlichen Strand und seine Dünen bekannt — perfekt für ruhige Morgen, lange Spaziergänge, Sandburgen und frische Meeresluft. Von Zeewind II aus wird Strandzeit leicht Teil des täglichen Rhythmus, ohne Auto oder großen Plan.',
        beachFact1: '<strong>Ideal für:</strong> Alle Altersgruppen, Spaziergänge, Entspannung, Familien',
        beachFact2: '<strong>Entfernung:</strong> Kurzer Spaziergang ab Zeewind II',
        ...
        cyclingCopy: 'Die belgische Küste lässt sich leicht mit dem Rad oder zu Fuß erkunden. Von Zeewind II aus können Gäste in ihrem eigenen Tempo Routen durch Bredene, die Dünen und nahe Küstenorte genießen — einen kurzen Familienspaziergang, eine längere Radtour oder eine schöne Strecke Richtung Meer.',
        ...
        ostendFact2: '<strong>Entfernung:</strong> Kurze Auto- oder Radfahrt ab Zeewind II',
        ...
        dehaanCopy: 'De Haan ist für seine charmante Küstenatmosphäre und Belle-Époque-Villen bekannt. Eine gute Option, wenn Sie eine andere Umgebung möchten und den Tag trotzdem einfach halten wollen. Genießen Sie einen Spaziergang, ein Getränk, eine Mahlzeit oder einfach ein anderes Küstengefühl, bevor Sie nach Zeewind II zurückkehren.',
        ...
        tourismCopy2: 'Dieser Link ist besonders hilfreich für aktuelle Aktivitäten in Bredene, die sich im Laufe des Jahres ändern, während diese Seite die praktischsten Optionen für Gäste in Zeewind II zusammenfasst.',
        ...
        ctaCopy: 'Übernachten Sie in Zeewind II und genießen Sie ein Ferienhaus im Herzen von Bredene, nahe Strand, Schwimmen, Essen und Trinken, Familienaktivitäten und einfachen Ausflügen entlang der belgischen Küste.'
      },
      bookingDynamic: {
