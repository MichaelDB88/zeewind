  ...
  var COPY = {
    en: {
      ...
      booking: {
        ...
        calendarSub: 'Start on Monday or Friday. Sunday check-out is only possible for a short weekend stay.',
        ...
        petSmall2: '🐾🐾 Yes - 2 small dogs (+€60)',
        petBig1: '🐕 Yes - 1 big dog (+€30)',
        petHelp: 'Dog supplement: €30 per dog per stay.',
      ...
      bookingDynamic: {
        ...
        clickCheckin: 'Click a Monday or Friday to choose your check-in. Click it again to clear your selection.',
        ...
        invalidCheckin: 'Check-in is only possible on Monday or Friday on an available date.',
        invalidCheckout: 'Choose a valid check-out: Friday or Monday, or Sunday only for a short weekend.',
        missingStay: 'Please choose a valid check-in and check-out date.',
        priceTitle: 'Price estimate',
        pricePrompt: 'Choose your dates, dogs and extras to see an estimate before sending your request.',
    ...
    nl: {
      ...
      booking: {
        ...
        calendarSub: 'Aankomst kan op maandag of vrijdag. Vertrek op zondag kan alleen bij een kort weekend.',
        ...
        petSmall2: '🐾🐾 Ja - 2 kleine honden (+€60)',
        petBig1: '🐕 Ja - 1 grote hond (+€30)',
        petHelp: 'Hondentoeslag: €30 per hond per verblijf.',
      ...
      bookingDynamic: {
        ...
        clickCheckin: 'Klik op een maandag of vrijdag om je aankomst te kiezen. Klik opnieuw om je selectie te wissen.',
        ...
        invalidCheckin: 'Aankomst is alleen mogelijk op maandag of vrijdag op een beschikbare datum.',
        invalidCheckout: 'Kies een geldig vertrek: vrijdag of maandag, of zondag alleen voor een kort weekend.',
        missingStay: 'Kies een geldige aankomst- en vertrekdatum.',
        priceTitle: 'Prijsindicatie',
        pricePrompt: 'Kies je data, honden en extra\'s om een prijsindicatie te zien voor je de aanvraag verstuurt.',
    ...
    fr: {
      ...
      booking: {
        ...
        calendarSub: 'Arrivée le lundi ou le vendredi. Le départ le dimanche est possible uniquement pour un court week-end.',
        ...
        petSmall2: '🐾🐾 Oui - 2 petits chiens (+€60)',
        petBig1: '🐕 Oui - 1 grand chien (+€30)',
        petHelp: 'Supplément chien : €30 par chien et par séjour.',
      ...
      bookingDynamic: {
        ...
        clickCheckin: 'Cliquez sur un lundi ou un vendredi pour choisir votre arrivée. Cliquez à nouveau pour effacer votre sélection.',
        ...
        invalidCheckin: 'L\'arrivée est possible uniquement le lundi ou le vendredi sur une date disponible.',
        invalidCheckout: 'Choisissez un départ valable : vendredi ou lundi, ou dimanche uniquement pour un court week-end.',
        missingStay: 'Choisissez une date d\'arrivée et de départ valables.',
        priceTitle: 'Estimation du prix',
        pricePrompt: 'Choisissez vos dates, chiens et options pour voir une estimation avant d\'envoyer votre demande.',
        rentalPrice: 'Loyer',
    ...
    de: {
      ...
      booking: {
        ...
        calendarSub: 'Anreise montags oder freitags. Abreise am Sonntag ist nur bei einem kurzen Wochenende möglich.',
        ...
        petSmall2: '🐾🐾 Ja - 2 kleine Hunde (+€60)',
        petBig1: '🐕 Ja - 1 großer Hund (+€30)',
        petHelp: 'Hundezuschlag: €30 pro Hund und Aufenthalt.',
      ...
      bookingDynamic: {
        ...
        clickCheckin: 'Klicken Sie auf einen Montag oder Freitag für Ihre Anreise. Klicken Sie erneut, um die Auswahl zu löschen.',
        ...
        invalidCheckin: 'Anreise ist nur montags oder freitags an einem verfügbaren Datum möglich.',
        invalidCheckout: 'Wählen Sie eine gültige Abreise: Freitag oder Montag, oder Sonntag nur für ein kurzes Wochenende.',
        missingStay: 'Bitte wählen Sie ein gültiges Anreise- und Abreisedatum.',
        priceTitle: 'Preisübersicht',
        pricePrompt: 'Wählen Sie Daten, Hunde und Extras, um vor dem Absenden eine Schätzung zu sehen.',
